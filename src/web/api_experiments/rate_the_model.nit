...
class GradeSession
	...
	init from_corpus(serie_id: String, user: User, config: NitwebConfig, serie: GradeSerie) do
		init(serie_id, user)
...
redef class User
	...
	fun has_rated(config: NitwebConfig, mentity: MEntity): Bool do
