...
#define COLOR_nitc__c_tools__CFunction___signature 0
...
#define COLOR_nitc___nitc__CFunction___core__kernel__Object__init 20
#define COLOR_nitc__c_tools__ExternFile___filename 0
#define COLOR_nitc__c_tools__ExternFile___pkgconfigs 1
#define COLOR_nitc___nitc__ExternFile___core__kernel__Object__init 22
#define COLOR_nitc__c_tools__ExternCFile___cflags 2
...
#define COLOR_nitc___nitc__ExternCFile___core__kernel__Object__init 25
