...
/* method astvalidation#ANode#validate for (self: ANode) */
void nitc__astvalidation___ANode___validate(val* self) {
val* var /* : ASTValidationVisitor */;
var = NEW_nitc__ASTValidationVisitor(&type_nitc__ASTValidationVisitor);
{
{ /* Inline kernel#Object#init (var) on <var:ASTValidationVisitor> */
RET_LABEL1:(void)0;
}
}
{
nitc___nitc__Visitor___enter_visit(var, self); /* Direct call parser_nodes#Visitor#enter_visit on <var:ASTValidationVisitor>*/
}
RET_LABEL:;
}
...
var41 = core__abstract_text___CString___to_s_full(var40, 52l, 52l);
var39 = var41;
varonce38 = var39;
}
...
var44 = " now with ";
var45 = core__abstract_text___CString___to_s_full(var44, 10l, 10l);
var43 = var45;
varonce42 = var43;
}
...
var61 = core__abstract_text___CString___to_s_full(var60, 25l, 25l);
var59 = var61;
varonce58 = var59;
}
...
var2 = core__abstract_text___CString___to_s_full(var1, 29l, 29l);
var = var2;
varonce = var;
}
{
