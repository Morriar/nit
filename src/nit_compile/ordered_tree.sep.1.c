...
var8 = "";
var9 = core__abstract_text___CString___to_s_full(var8, 0l, 0l);
var7 = var9;
varonce = var7;
}
{
...
var12 = "";
var13 = core__abstract_text___CString___to_s_full(var12, 0l, 0l);
var11 = var13;
varonce10 = var11;
}
{
ordered_tree___ordered_tree__OrderedTree___sub_write_to(self, var_stream, var_r, var11); /* Direct call ordered_tree#OrderedTree#sub_write_to on <self:OrderedTree[Object]>*/
}
{
...
{
var20 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var17); /* + on <var_prefix:String>*/
}
{
ordered_tree___ordered_tree__OrderedTree___write_line(self, var_o, var_e2, var20); /* Direct call ordered_tree#OrderedTree#write_line on <self:OrderedTree[Object]>*/
}
...
{
var25 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var22); /* + on <var_prefix:String>*/
}
{
ordered_tree___ordered_tree__OrderedTree___sub_write_to(self, var_o, var_e2, var25); /* Direct call ordered_tree#OrderedTree#sub_write_to on <self:OrderedTree[Object]>*/
}
} else {
...
var28 = "`--";
var29 = core__abstract_text___CString___to_s_full(var28, 3l, 3l);
var27 = var29;
varonce26 = var27;
}
{
var30 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var27); /* + on <var_prefix:String>*/
}
{
ordered_tree___ordered_tree__OrderedTree___write_line(self, var_o, var_e2, var30); /* Direct call ordered_tree#OrderedTree#write_line on <self:OrderedTree[Object]>*/
}
...
{
var35 = ((val*(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___43d]))(var_prefix, var32); /* + on <var_prefix:String>*/
}
{
ordered_tree___ordered_tree__OrderedTree___sub_write_to(self, var_o, var_e2, var35); /* Direct call ordered_tree#OrderedTree#sub_write_to on <self:OrderedTree[Object]>*/
}
}
{
...
{
var6 = ordered_tree___ordered_tree__OrderedTree___display(self, var_e);
}
...
varonce = var1;
{
((void(*)(val* self, val* p0))(var_o->class->vft[COLOR_core__stream__Writer__write]))(var_o, var7); /* write on <var_o:Writer>*/
}
RET_LABEL:;
}
