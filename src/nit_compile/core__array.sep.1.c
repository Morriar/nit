...
const char* var_class_name47;
long var_start48 /* var start: Int */;
long var_length /* var length: Int */;
val* var_dest49 /* var dest: NativeArray[nullable Object] */;
...
var_start48 = var_start;
var_length = var_len;
var_dest49 = var_dest_items;
var_dest_start = var_new_start;
{
{ /* Inline kernel#Int#< (var_start48,var_dest_start) on <var_start48:Int> */
/* Covariant cast for argument 0 (i) <var_dest_start:Int> isa OTHER */
/* <var_dest_start:Int> isa OTHER */
var52 = 1; /* easy <var_dest_start:Int> isa OTHER*/
if (unlikely(!var52)) {
...
var56 = var_start48 < var_dest_start;
var50 = var56;
goto RET_LABEL51;
RET_LABEL51:(void)0;
}
...
{
{ /* Inline kernel#Int#+ (var_start48,var_i) on <var_start48:Int> */
/* Covariant cast for argument 0 (i) <var_i:Int> isa OTHER */
/* <var_i:Int> isa OTHER */
var80 = 1; /* easy <var_i:Int> isa OTHER*/
if (unlikely(!var80)) {
...
{
{ /* Inline array#NativeArray#[] (var_items,var78) on <var_items:nullable NativeArray[nullable Object](NativeArray[nullable Object])> */
var87 = ((struct instance_core__NativeArray*)var_items)->values[var78];
var85 = var87;
goto RET_LABEL86;
RET_LABEL86:(void)0;
}
...
{
{ /* Inline array#NativeArray#[]= (var_dest49,var71,var85) on <var_dest49:NativeArray[nullable Object]> */
/* Covariant cast for argument 1 (item) <var85:nullable Object> isa E */
/* <var85:nullable Object> isa E */
type_struct92 = var_dest49->type->resolution_table->types[COLOR_core__NativeArray___35dE];
cltype90 = type_struct92->color;
idtype91 = type_struct92->id;
is_nullable = type_struct92->is_nullable;
if(var85 == NULL) {
var89 = is_nullable;
} else {
if(cltype90 >= (((long)var85&3)?type_info[((long)var85&3)]:var85->type)->table_size) {
var89 = 0;
} else {
var89 = (((long)var85&3)?type_info[((long)var85&3)]:var85->type)->type_table[cltype90] == idtype91;
}
}
if (unlikely(!var89)) {
var_class_name93 = var85 == NULL ? "null" : (((long)var85&3)?type_info[((long)var85&3)]:var85->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name93);
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 991);
fatal_exit(1);
}
((struct instance_core__NativeArray*)var_dest49)->values[var71]=var85;
RET_LABEL88:(void)0;
}
}
} else {
...
for(;;) {
{
{ /* Inline kernel#Int#< (var_i94,var_length) on <var_i94:Int> */
/* Covariant cast for argument 0 (i) <var_length:Int> isa OTHER */
/* <var_length:Int> isa OTHER */
var97 = 1; /* easy <var_length:Int> isa OTHER*/
if (unlikely(!var97)) {
...
if (var95){
{
{ /* Inline kernel#Int#+ (var_dest_start,var_i94) on <var_dest_start:Int> */
/* Covariant cast for argument 0 (i) <var_i94:Int> isa OTHER */
/* <var_i94:Int> isa OTHER */
var104 = 1; /* easy <var_i94:Int> isa OTHER*/
if (unlikely(!var104)) {
...
{
{ /* Inline kernel#Int#+ (var_start48,var_i94) on <var_start48:Int> */
/* Covariant cast for argument 0 (i) <var_i94:Int> isa OTHER */
/* <var_i94:Int> isa OTHER */
var111 = 1; /* easy <var_i94:Int> isa OTHER*/
if (unlikely(!var111)) {
...
{
{ /* Inline array#NativeArray#[] (var_items,var109) on <var_items:nullable NativeArray[nullable Object](NativeArray[nullable Object])> */
var118 = ((struct instance_core__NativeArray*)var_items)->values[var109];
var116 = var118;
goto RET_LABEL117;
RET_LABEL117:(void)0;
}
...
{
{ /* Inline array#NativeArray#[]= (var_dest49,var102,var116) on <var_dest49:NativeArray[nullable Object]> */
/* Covariant cast for argument 1 (item) <var116:nullable Object> isa E */
/* <var116:nullable Object> isa E */
type_struct123 = var_dest49->type->resolution_table->types[COLOR_core__NativeArray___35dE];
cltype121 = type_struct123->color;
idtype122 = type_struct123->id;
is_nullable124 = type_struct123->is_nullable;
if(var116 == NULL) {
var120 = is_nullable124;
} else {
if(cltype121 >= (((long)var116&3)?type_info[((long)var116&3)]:var116->type)->table_size) {
var120 = 0;
} else {
var120 = (((long)var116&3)?type_info[((long)var116&3)]:var116->type)->type_table[cltype121] == idtype122;
}
}
if (unlikely(!var120)) {
var_class_name125 = var116 == NULL ? "null" : (((long)var116&3)?type_info[((long)var116&3)]:var116->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name125);
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 991);
fatal_exit(1);
}
((struct instance_core__NativeArray*)var_dest49)->values[var102]=var116;
RET_LABEL119:(void)0;
}
}
{
{ /* Inline kernel#Int#+ (var_i94,1l) on <var_i94:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
/* <1l:Int> isa OTHER */
...
int cltype72;
int idtype73;
const struct type* type_struct74;
short int is_nullable75;
const char* var_class_name76;
long var77 /* : Int */;
...
{
{ /* Inline kernel#Int#+ (var_start,var_i45) on <var_start:Int> */
/* Covariant cast for argument 0 (i) <var_i45:Int> isa OTHER */
/* <var_i45:Int> isa OTHER */
var62 = 1; /* easy <var_i45:Int> isa OTHER*/
if (unlikely(!var62)) {
var_class_name65 = type_core__Int.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name65);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 728);
...
{
{ /* Inline array#NativeArray#[] (self,var60) on <self:NativeArray[nullable Object]> */
var69 = ((struct instance_core__NativeArray*)self)->values[var60];
var67 = var69;
goto RET_LABEL68;
RET_LABEL68:(void)0;
}
...
{
{ /* Inline array#NativeArray#[]= (var_dest,var53,var67) on <var_dest:NativeArray[nullable Object]> */
/* Covariant cast for argument 1 (item) <var67:nullable Object> isa E */
/* <var67:nullable Object> isa E */
type_struct74 = var_dest->type->resolution_table->types[COLOR_core__NativeArray___35dE];
cltype72 = type_struct74->color;
idtype73 = type_struct74->id;
is_nullable75 = type_struct74->is_nullable;
if(var67 == NULL) {
var71 = is_nullable75;
} else {
if(cltype72 >= (((long)var67&3)?type_info[((long)var67&3)]:var67->type)->table_size) {
var71 = 0;
} else {
var71 = (((long)var67&3)?type_info[((long)var67&3)]:var67->type)->type_table[cltype72] == idtype73;
}
}
if (unlikely(!var71)) {
var_class_name76 = var67 == NULL ? "null" : (((long)var67&3)?type_info[((long)var67&3)]:var67->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name76);
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 991);
fatal_exit(1);
}
((struct instance_core__NativeArray*)var_dest)->values[var53]=var67;
RET_LABEL70:(void)0;
}
}
{
{ /* Inline kernel#Int#+ (var_i45,1l) on <var_i45:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
/* <1l:Int> isa OTHER */
