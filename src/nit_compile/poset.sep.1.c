...
var_elements = p0;
var2 = NEW_core__Array(self->type->resolution_table->types[COLOR_core__Array__poset__POSet___35dE]);
{
...
var_7 = var_elements;
{
var8 = ((val*(*)(val* self))((((long)var_7&3)?class_info[((long)var_7&3)]:var_7->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_7); /* iterator on <var_7:Collection[nullable Object]>*/
}
var_9 = var8;
for(;;) {
{
var10 = ((short int(*)(val* self))((((long)var_9&3)?class_info[((long)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(var_9); /* is_ok on <var_9:Iterator[nullable Object]>*/
}
if (var10){
} else {
goto BREAK_label;
...
{
var11 = ((val*(*)(val* self))((((long)var_9&3)?class_info[((long)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var_9); /* item on <var_9:Iterator[nullable Object]>*/
}
var_f = var11;
if (var_e == NULL) {
var12 = (var_f == NULL);
} else {
var13 = ((short int(*)(val* self, val* p0))((((long)var_e&3)?class_info[((long)var_e&3)]:var_e->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_e, var_f); /* == on <var_e:nullable Object>*/
var12 = var13;
}
if (var12){
goto BREAK_label14;
...
{
var15 = poset___poset__POSet___has_edge(self, var_f, var_e);
}
if (var15){
goto BREAK_16;
} else {
...
{
((void(*)(val* self))((((long)var_9&3)?class_info[((long)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__next]))(var_9); /* next on <var_9:Iterator[nullable Object]>*/
}
}
BREAK_label: (void)0;
{
((void(*)(val* self))((((long)var_9&3)?class_info[((long)var_9&3)]:var_9->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var_9); /* finish on <var_9:Iterator[nullable Object]>*/
}
{
core___core__Array___core__abstract_collection__SimpleCollection__add(var_res, var_e); /* Direct call array#Array#add on <var_res:Array[nullable Object]>*/
}
BREAK_16: (void)0;
{
...
/* method poset#POSet#core_serialize_to for (self: POSet[nullable Object], Serializer) */
void poset___poset__POSet___serialization__Serializable__core_serialize_to(val* self, val* p0) {
...
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var, var3); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
RET_LABEL:;
}
...
/* method poset#POSetElement#core_serialize_to for (self: POSetElement[nullable Object], Serializer) */
void poset___poset__POSetElement___serialization__Serializable__core_serialize_to(val* self, val* p0) {
val* var_serializer /* var serializer: Serializer */;
static val* varonce;
val* var /* : String */;
char* var1 /* : CString */;
...
val* var33 /* : HashSet[nullable Object] */;
...
{
{ /* Inline poset#POSetElement#poset (self) on <self:POSetElement[nullable Object]> */
var5 = self->attrs[COLOR_poset__POSetElement___poset].val; /* _poset on <self:POSetElement[nullable Object]> */
if (unlikely(var5 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _poset");
PRINT_ERROR(" (%s:%d)\n", FILE_poset, 526);
fatal_exit(1);
...
var8 = "element";
var9 = core__abstract_text___CString___to_s_full(var8, 7l, 7l);
var7 = var9;
varonce6 = var7;
}
{
{ /* Inline poset#POSetElement#element (self) on <self:POSetElement[nullable Object]> */
var12 = self->attrs[COLOR_poset__POSetElement___element].val; /* _element on <self:POSetElement[nullable Object]> */
var10 = var12;
RET_LABEL11:(void)0;
}
}
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var7, var10); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
...
{
{ /* Inline poset#POSetElement#tos (self) on <self:POSetElement[nullable Object]> */
var19 = self->attrs[COLOR_poset__POSetElement___tos].val; /* _tos on <self:POSetElement[nullable Object]> */
...
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var14, var17); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
if (likely(varonce20!=NULL)) {
var21 = varonce20;
} else {
var22 = "froms";
var23 = core__abstract_text___CString___to_s_full(var22, 5l, 5l);
var21 = var23;
varonce20 = var21;
}
{
{ /* Inline poset#POSetElement#froms (self) on <self:POSetElement[nullable Object]> */
var26 = self->attrs[COLOR_poset__POSetElement___froms].val; /* _froms on <self:POSetElement[nullable Object]> */
if (unlikely(var26 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _froms");
PRINT_ERROR(" (%s:%d)\n", FILE_poset, 533);
fatal_exit(1);
...
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var21, var24); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
...
{
{ /* Inline poset#POSetElement#dtos (self) on <self:POSetElement[nullable Object]> */
var33 = self->attrs[COLOR_poset__POSetElement___dtos].val; /* _dtos on <self:POSetElement[nullable Object]> */
...
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var28, var31); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
if (likely(varonce34!=NULL)) {
var35 = varonce34;
} else {
var36 = "dfroms";
var37 = core__abstract_text___CString___to_s_full(var36, 6l, 6l);
var35 = var37;
varonce34 = var35;
}
{
{ /* Inline poset#POSetElement#dfroms (self) on <self:POSetElement[nullable Object]> */
var40 = self->attrs[COLOR_poset__POSetElement___dfroms].val; /* _dfroms on <self:POSetElement[nullable Object]> */
...
{
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var35, var38); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
...
{
{ /* Inline poset#POSetElement#count (self) on <self:POSetElement[nullable Object]> */
var47 = self->attrs[COLOR_poset__POSetElement___count].l; /* _count on <self:POSetElement[nullable Object]> */
var45 = var47;
RET_LABEL46:(void)0;
}
}
{
var48 = (val*)(var45<<2|1);
json___json__JsonSerializer___serialization__Serializer__serialize_attribute(var_serializer, var42, var48); /* Direct call serialization_write#JsonSerializer#serialize_attribute on <var_serializer:Serializer>*/
}
RET_LABEL:;
}
