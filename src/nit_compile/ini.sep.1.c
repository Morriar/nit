...
varonce = var11;
{
((void(*)(val* self, val* p0))(var_stream->class->vft[COLOR_core__stream__Writer__write]))(var_stream, var25); /* write on <var_stream:Writer>*/
}
...
var55 = core__abstract_text___CString___to_s_full(var54, 29l, 29l);
var53 = var55;
varonce52 = var53;
}
...
var1 = ".";
var2 = core__abstract_text___CString___to_s_full(var1, 1l, 1l);
var = var2;
varonce = var;
}
{
