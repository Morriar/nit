...
extern const char FILE_nitc__nitni_base[];
...
#define COLOR_nitc__nitni_base___MClassType___MType__cname_blind 88
...
#define COLOR_nitc__nitni_base___MGenericType___MType__mangled_cname 97
