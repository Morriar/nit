...
void nitc___nitc__CCompilationUnit___add_local_function(val* self, val* p0) {
...
var3 = NEW_core__NativeArray(3l, &type_core__NativeArray__core__String);
if (likely(varonce4!=NULL)) {
var5 = varonce4;
} else {
var6 = "static ";
var7 = core__abstract_text___CString___to_s_full(var6, 7l, 7l);
var5 = var7;
varonce4 = var5;
}
...
((struct instance_core__NativeArray*)var3)->values[2]=var9;
} else {
var3 = varonce;
varonce = NULL;
}
...
var14 = var_c_function->attrs[COLOR_nitc__c_tools__CFunction___signature].val; /* _signature on <var_c_function:CFunction> */
...
((struct instance_core__NativeArray*)var3)->values[1]=var12;
{
var15 = ((val*(*)(val* self))(var3->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var3); /* native_to_s on <var3:NativeArray[String]>*/
}
varonce = var3;
{
template___template__Template___add(var, var15); /* Direct call template#Template#add on <var:Template>*/
}
{
{ /* Inline c_tools#CCompilationUnit#body_impl (self) on <self:CCompilationUnit> */
var18 = self->attrs[COLOR_nitc__c_tools__CCompilationUnit___body_impl].val; /* _body_impl on <self:CCompilationUnit> */
...
{
template___template__Template___add(var16, var20); /* Direct call template#Template#add on <var16:Template>*/
}
{
{ /* Inline c_tools#CCompilationUnit#body_impl (self) on <self:CCompilationUnit> */
var25 = self->attrs[COLOR_nitc__c_tools__CCompilationUnit___body_impl].val; /* _body_impl on <self:CCompilationUnit> */
...
{
var26 = nitc___nitc__CFunction___to_writer(var_c_function);
}
{
template___template__Template___add(var23, var26); /* Direct call template#Template#add on <var23:Template>*/
}
RET_LABEL:;
}
/* method c_tools#CCompilationUnit#add_exported_function for (self: CCompilationUnit, CFunction) */
void nitc___nitc__CCompilationUnit___add_exported_function(val* self, val* p0) {
val* var_c_function /* var c_function: CFunction */;
val* var /* : Template */;
val* var2 /* : Template */;
val* var3 /* : NativeArray[String] */;
...
var6 = ";\n";
var7 = core__abstract_text___CString___to_s_full(var6, 2l, 2l);
var5 = var7;
varonce4 = var5;
}
...
{
{ /* Inline c_tools#CFunction#signature (var_c_function) on <var_c_function:CFunction> */
var10 = var_c_function->attrs[COLOR_nitc__c_tools__CFunction___signature].val; /* _signature on <var_c_function:CFunction> */
...
((struct instance_core__NativeArray*)var3)->values[0]=var8;
{
var11 = ((val*(*)(val* self))(var3->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var3); /* native_to_s on <var3:NativeArray[String]>*/
}
varonce = var3;
{
...
var6 = "\n{\n";
var7 = core__abstract_text___CString___to_s_full(var6, 3l, 3l);
var5 = var7;
varonce = var5;
}
{
...
/* method c_tools#ExternFile#compiles_to_o_file for (self: ExternFile): Bool */
short int nitc___nitc__ExternFile___compiles_to_o_file(val* self) {
short int var /* : Bool */;
var = 0;
goto RET_LABEL;
RET_LABEL:;
...
var5 = ".c";
var6 = core__abstract_text___CString___to_s_full(var5, 2l, 2l);
var4 = var6;
varonce = var4;
}
{
...
var12 = ".extern.o";
var13 = core__abstract_text___CString___to_s_full(var12, 9l, 9l);
var11 = var13;
varonce10 = var11;
}
...
var19 = core__abstract_text___CString___to_s_full(var18, 21l, 21l);
var17 = var19;
varonce16 = var17;
}
...
{
var31 = core__abstract_text___Collection___join(var24, var28, ((val*)NULL));
}
...
var38 = core__abstract_text___CString___to_s_full(var37, 43l, 43l);
var36 = var38;
varonce35 = var36;
}
