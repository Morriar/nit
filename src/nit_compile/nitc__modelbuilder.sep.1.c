...
val* var40 /* : POSetElement[MModule] */;
val* var42 /* : POSetElement[MModule] */;
val* var43 /* : Collection[nullable Object] */;
...
{
var15 = ((val*(*)(val* self, val* p0))(var9->class->vft[COLOR_core__abstract_text__Text___43d]))(var9, var12); /* + on <var9:String>*/
}
var16 = NEW_nitc__Location(&type_nitc__Location);
{
var17 = core___core__SequenceRead___Collection__first(var_mmodules);
}
{
{ /* Inline mmodule#MModule#location (var17) on <var17:nullable Object(MModule)> */
var20 = var17->attrs[COLOR_nitc__mmodule__MModule___location].val; /* _location on <var17:nullable Object(MModule)> */
...
{
{ /* Inline location#Location#file (var18) on <var18:Location> */
var23 = var18->attrs[COLOR_nitc__location__Location___file].val; /* _file on <var18:Location> */
var21 = var23;
RET_LABEL22:(void)0;
}
}
{
((void(*)(val* self, val* p0))(var16->class->vft[COLOR_nitc__location__Location__file_61d]))(var16, var21); /* file= on <var16:Location>*/
}
{
((void(*)(val* self, long p0))(var16->class->vft[COLOR_nitc__location__Location__line_start_61d]))(var16, 0l); /* line_start= on <var16:Location>*/
}
{
((void(*)(val* self, long p0))(var16->class->vft[COLOR_nitc__location__Location__line_end_61d]))(var16, 0l); /* line_end= on <var16:Location>*/
}
{
((void(*)(val* self, long p0))(var16->class->vft[COLOR_nitc__location__Location__column_start_61d]))(var16, 0l); /* column_start= on <var16:Location>*/
}
{
((void(*)(val* self, long p0))(var16->class->vft[COLOR_nitc__location__Location__column_end_61d]))(var16, 0l); /* column_end= on <var16:Location>*/
}
{
((void(*)(val* self))(var16->class->vft[COLOR_core__kernel__Object__init]))(var16); /* init on <var16:Location>*/
}
{
...
{
((void(*)(val* self, val* p0))(var3->class->vft[COLOR_nitc__mmodule__MModule__name_61d]))(var3, var15); /* name= on <var3:MModule>*/
}
{
((void(*)(val* self, val* p0))(var3->class->vft[COLOR_nitc__mmodule__MModule__location_61d]))(var3, var16); /* location= on <var3:MModule>*/
}
{
...
{
var25 = core___core__SequenceRead___Collection__first(var_mmodules);
}
{
{ /* Inline mmodule#MModule#first_real_mmodule (var25) on <var25:nullable Object(MModule)> */
var28 = var25->attrs[COLOR_nitc__mmodule__MModule___first_real_mmodule].val; /* _first_real_mmodule on <var25:nullable Object(MModule)> */
...
{
{ /* Inline mmodule#MModule#first_real_mmodule= (var_mainmodule,var26) on <var_mainmodule:nullable Object(MModule)> */
var_mainmodule->attrs[COLOR_nitc__mmodule__MModule___first_real_mmodule].val = var26; /* _first_real_mmodule on <var_mainmodule:nullable Object(MModule)> */
RET_LABEL29:(void)0;
}
}
{
...
{
var30 = nitc__modelbuilder_base___ToolContext___modelbuilder(self);
}
{
nitc__loader___ModelBuilder___apply_conditional_importations(var30, var_mainmodule); /* Direct call loader#ModelBuilder#apply_conditional_importations on <var30:ModelBuilder>*/
}
{
{ /* Inline mmodule#MModule#in_importation (var_mainmodule) on <var_mainmodule:nullable Object(MModule)> */
var34 = var_mainmodule->attrs[COLOR_nitc__mmodule__MModule___in_importation].val; /* _in_importation on <var_mainmodule:nullable Object(MModule)> */
...
{
var35 = poset___poset__POSetElement___direct_greaters(var32);
}
{
var36 = ((long(*)(val* self))((((long)var35&3)?class_info[((long)var35&3)]:var35->class)->vft[COLOR_core__abstract_collection__Collection__length]))(var35); /* length on <var35:Collection[nullable Object](Collection[MModule])>*/
}
{
...
{
{ /* Inline mmodule#MModule#in_importation (var_mainmodule) on <var_mainmodule:nullable Object(MModule)> */
var42 = var_mainmodule->attrs[COLOR_nitc__mmodule__MModule___in_importation].val; /* _in_importation on <var_mainmodule:nullable Object(MModule)> */
...
{
var43 = poset___poset__POSetElement___direct_greaters(var40);
}
{
var44 = ((val*(*)(val* self))((((long)var43&3)?class_info[((long)var43&3)]:var43->class)->vft[COLOR_core__abstract_collection__Collection__first]))(var43); /* first on <var43:Collection[nullable Object](Collection[MModule])>*/
}
{
var45 = core___core__SequenceRead___Collection__first(var_mmodules);
}
{
{ /* Inline kernel#Object#== (var44,var45) on <var44:nullable Object(MModule)> */
var_other = var45;
{
{ /* Inline kernel#Object#is_same_instance (var44,var_other) on <var44:nullable Object(MModule)> */
...
if (var31){
{
var51 = core___core__SequenceRead___Collection__first(var_mmodules);
}
var_mainmodule = var51;
} else {
{
var52 = nitc__modelbuilder_base___ToolContext___modelbuilder(self);
}
{
nitc__modelbuilder___ModelBuilder___run_phases(var52); /* Direct call modelbuilder#ModelBuilder#run_phases on <var52:ModelBuilder>*/
}
}
var = var_mainmodule;
goto RET_LABEL;
...
var38 = core__abstract_text___CString___to_s_full(var37, 18l, 18l);
var36 = var38;
varonce = var36;
}
{
