...
{
var36 = ((long(*)(val* self, val* p0))(self->class->vft[COLOR_core__hash_collection__HashCollection__index_at]))(self, var35); /* index_at on <self:HashCollection[nullable Object]>*/
}
var_index = var36;
{
