...
{
var7 = ((long(*)(val* self))(self->class->vft[COLOR_core__abstract_text__Text__byte_length]))(self); /* byte_length on <self:Text>*/
}
{
{ /* Inline kernel#Int#+ (var_add_sp,var7) on <var_add_sp:Int> */
...
{
var12 = core__flat___Buffer___with_cap(var6, var8);
}
var_bf = var12;
{
...
{
var21 = ((uint32_t(*)(val* self, long p0))(self->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(self, var_i); /* [] on <self:Text>*/
}
var_c = var21;
{
{ /* Inline kernel#Char#== (var_c,var_delim_char) on <var_c:Char> */
var24 = var_c == var_delim_char;
var22 = var24;
goto RET_LABEL23;
RET_LABEL23:(void)0;
}
...
{
var26 = ((val*(*)(val* self))(var_bf->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_bf); /* to_s on <var_bf:Buffer>*/
}
var = var26;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self, val* p0))(var_os->class->vft[COLOR_core__stream__Writer__write]))(var_os, var28); /* write on <var_os:Writer>*/
}
{
...
{
((void(*)(val* self, val* p0))(var_os->class->vft[COLOR_core__stream__Writer__write]))(var_os, var32); /* write on <var_os:Writer>*/
}
{
((void(*)(val* self, val* p0))(var_os->class->vft[COLOR_core__stream__Writer__write]))(var_os, var_eol); /* write on <var_os:Writer>*/
}
RET_LABEL:;
}
