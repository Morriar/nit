...
#define COLOR_nitc__mmodule__MGroup___default_mmodule 8
...
#define COLOR_nitc__mmodule__MModule___full_name 46
...
#define COLOR_nitc__mmodule__MModule___c_name 48
...
#define COLOR_nitc___nitc__MModule___core__kernel__Object__init 130
