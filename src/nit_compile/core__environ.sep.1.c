...
var4 = environ___CString_get_environ___impl(var1);
var2 = var4;
goto RET_LABEL3;
RET_LABEL3:(void)0;
}
...
{
{ /* Inline environ#CString#get_environ (var10) on <var10:CString> */
var13 = environ___CString_get_environ___impl(var10);
var11 = var13;
goto RET_LABEL12;
RET_LABEL12:(void)0;
}
...
var21 = "";
var22 = core__abstract_text___CString___to_s_full(var21, 0l, 0l);
var20 = var22;
varonce19 = var20;
}
var = var20;
...
char* var /* : CString */;
char* var1 /* : CString */;
var1 = environ___CString_get_environ___impl(self);
var = var1;
goto RET_LABEL;
RET_LABEL:;
return var;
...
if (var8){
{
var12 = core__fixed_ints_text___Text___to_i(var_x);
}
{
