...
extern const struct class class_nitc__no_warning__NoWarningPhase;
...
#define COLOR_nitc__model__MVirtualType__mproperty_61d 75
...
#define COLOR_nitc__light_ffi__MModule___present_languages 62
...
#define COLOR_nitc__cpp__MModule___cppflags 71
#define COLOR_nitc__objc__MModule___has_public_objc_header 76
val* NEW_nitc__ForeignCallbackSet(const struct type* type);
extern const struct type type_nitc__ForeignCallbackSet;
#define COLOR_nitc__java__MModule___callbacks_used_from_java 72
#define COLOR_nitc__compiler_ffi__MModule___foreign_callbacks 57
extern const struct type type_core__Array__nitc__NitniCallback;
#define COLOR_nitc__compiler_ffi__MModule___compiled_callbacks 58
...
#define COLOR_nitc__model__MNullType__model_61d 74
...
extern const struct class class_core__StringWriter;
#define COLOR_core__stream__StringWriter___content 1
#define COLOR_core__stream__StringWriter___closed 2
...
extern const struct class class_core__Process;
...
extern const struct class class_core__ProcessReader;
...
extern const struct class class_core__Regex;
...
#define COLOR_core__HashMap__ordered_tree__OrderedTree___35dE__core__Array__ordered_tree__OrderedTree___35dE 1
#define COLOR_ordered_tree__OrderedTree___sub 2
#define COLOR_core__HashMap__ordered_tree__OrderedTree___35dE__nullable__ordered_tree__OrderedTree___35dE 2
...
val* NEW_nitc__simple_misc_analysis__SimpleMiscAnalysisPhase(const struct type* type);
extern const struct type type_nitc__simple_misc_analysis__SimpleMiscAnalysisPhase;
#define COLOR_nitc__phase__Phase__toolcontext_61d 15
#define COLOR_nitc__phase__Phase__depends_61d 16
...
val* NEW_nitc__glsl_validation__GLSLValidationPhase(const struct type* type);
extern const struct type type_nitc__glsl_validation__GLSLValidationPhase;
extern const struct type type_core__Array__nitc__Phase;
extern const char FILE_nitc__literal[];
#define COLOR_nitc__glsl_validation__ToolContext___glsl_validation_phase 61
...
extern const struct type type_nitc__no_warning__NoWarningPhase;
#define COLOR_nitc__no_warning__ToolContext___no_warning_phase 1
...
val* NEW_nitc__check_annotation__CheckAnnotationPhase(const struct type* type);
extern const struct type type_nitc__check_annotation__CheckAnnotationPhase;
#define COLOR_nitc__check_annotation__ToolContext___check_annotation_phase 60
...
#define COLOR_nitc__local_var_init__ToolContext___local_var_init_phase 52
...
val* NEW_nitc__deriving__DerivingPhase(const struct type* type);
extern const struct type type_nitc__deriving__DerivingPhase;
#define COLOR_nitc__deriving__ToolContext___deriving_phase 59
val* NEW_nitc__regex_phase__RegexPhase(const struct type* type);
extern const struct type type_nitc__regex_phase__RegexPhase;
#define COLOR_nitc__regex_phase__ToolContext___regex_phase 64
val* NEW_nitc__serialization_phase__SerializationPhaseRename(const struct type* type);
extern const struct type type_nitc__serialization_phase__SerializationPhaseRename;
#define COLOR_nitc__serialization_phase__ToolContext___serialization_phase_rename 56
val* NEW_nitc__serialization_phase__SerializationPhasePreModel(const struct type* type);
extern const struct type type_nitc__serialization_phase__SerializationPhasePreModel;
extern const char FILE_nitc__serialization_phase[];
#define COLOR_nitc__serialization_phase__ToolContext___serialization_phase_pre_model 57
val* NEW_nitc__serialization_phase__SerializationPhasePostModel(const struct type* type);
extern const struct type type_nitc__serialization_phase__SerializationPhasePostModel;
extern const char FILE_nitc__modelize_property[];
#define COLOR_nitc__serialization_phase__ToolContext___serialization_phase_post_model 58
val* NEW_nitc__platform__PlatformPhase(const struct type* type);
extern const struct type type_nitc__platform__PlatformPhase;
#define COLOR_nitc__platform__ToolContext___platform_phase 111
...
#define COLOR_nitc__extern_classes__ToolContext___extern_classes_typing_phase_model 118
...
val* NEW_nitc__div_by_zero__DivByZeroPhase(const struct type* type);
extern const struct type type_nitc__div_by_zero__DivByZeroPhase;
#define COLOR_nitc__div_by_zero__ToolContext___div_by_zero_phase 55
val* NEW_nitc__i18n_phase__I18NPhase(const struct type* type);
extern const struct type type_nitc__i18n_phase__I18NPhase;
#define COLOR_nitc__i18n_phase__ToolContext___localize_phase 63
val* NEW_nitc__parallelization_phase__ParallelizationPhase(const struct type* type);
extern const struct type type_nitc__parallelization_phase__ParallelizationPhase;
#define COLOR_nitc__parallelization_phase__ToolContext___parallelization_phase 62
...
#define COLOR_nitc__transform__ToolContext___transform_phase 125
...
extern const struct type type_nitc__VerifyNitniCallbacksPhase;
#define COLOR_nitc__nitni_callbacks__ToolContext___verify_nitni_callback_phase 119
val* NEW_nitc__header_dependency__HeaderDependancyPhase(const struct type* type);
extern const struct type type_nitc__header_dependency__HeaderDependancyPhase;
#define COLOR_nitc__header_dependency__ToolContext___header_dependancy_phase 121
val* NEW_nitc__PkgconfigPhase(const struct type* type);
extern const struct type type_nitc__PkgconfigPhase;
#define COLOR_nitc__pkgconfig__ToolContext___pkgconfig_phase 122
...
#define COLOR_nitc__memory_logger__ToolContext___opt_trace_memory 120
#define COLOR_nitc__global_compiler__ToolContext___opt_global 114
val* NEW_nitc__GlobalCompilerPhase(const struct type* type);
extern const struct type type_nitc__GlobalCompilerPhase;
#define COLOR_nitc__global_compiler__ToolContext___global_compiler_phase 115
#define COLOR_nitc__separate_compiler__ToolContext___opt_separate 69
#define COLOR_nitc__separate_compiler__ToolContext___opt_no_inline_intern 70
#define COLOR_nitc__separate_compiler__ToolContext___opt_no_union_attribute 71
#define COLOR_nitc__separate_compiler__ToolContext___opt_no_shortcut_equate 72
#define COLOR_nitc__separate_compiler__ToolContext___opt_no_tag_primitives 73
#define COLOR_nitc__separate_compiler__ToolContext___opt_colors_are_symbols 74
#define COLOR_nitc__separate_compiler__ToolContext___opt_trampoline_call 75
#define COLOR_nitc__separate_compiler__ToolContext___opt_guard_call 76
#define COLOR_nitc__separate_compiler__ToolContext___opt_substitute_monomorph 77
#define COLOR_nitc__separate_compiler__ToolContext___opt_link_boost 78
#define COLOR_nitc__separate_compiler__ToolContext___opt_inline_coloring_numbers 79
#define COLOR_nitc__separate_compiler__ToolContext___opt_inline_some_methods 80
#define COLOR_nitc__separate_compiler__ToolContext___opt_direct_call_monomorph 81
#define COLOR_nitc__separate_compiler__ToolContext___opt_direct_call_monomorph0 82
#define COLOR_nitc__separate_compiler__ToolContext___opt_skip_dead_methods 83
#define COLOR_nitc__separate_compiler__ToolContext___opt_semi_global 84
#define COLOR_nitc__separate_compiler__ToolContext___opt_colo_dead_methods 85
#define COLOR_nitc__separate_compiler__ToolContext___opt_tables_metrics 86
#define COLOR_nitc__separate_compiler__ToolContext___opt_type_poset 87
val* NEW_nitc__SeparateCompilerPhase(const struct type* type);
extern const struct type type_nitc__SeparateCompilerPhase;
#define COLOR_nitc__separate_compiler__ToolContext___separate_compiler_phase 88
...
#define COLOR_nitc__separate_erasure_compiler__ToolContext___erasure_compiler_phase 68
val* NEW_nitc__c_compiler_options__CCompilerOptionsPhase(const struct type* type);
extern const struct type type_nitc__c_compiler_options__CCompilerOptionsPhase;
extern const char FILE_nitc__platform[];
#define COLOR_nitc__c_compiler_options__ToolContext___cflags_phase 123
val* NEW_nitc__extra_java_files__JavaExtraFilesPhase(const struct type* type);
extern const struct type type_nitc__extra_java_files__JavaExtraFilesPhase;
#define COLOR_nitc__extra_java_files__ToolContext___extra_java_files_phase 124
#define COLOR_nitc__frontend__ToolContext___dummy 0
...
#define COLOR_nitc__parser_nodes__ANodes__parent_61d 15
...
#define COLOR_nitc__serialization_phase__AModule___inits_to_retype 13
...
extern const struct class class_nitc__simple_misc_analysis__SimpleMiscAnalysisPhase;
...
extern const struct class class_nitc__simple_misc_analysis__SimpleMiscVisitor;
...
extern const struct class class_nitc__MModuleData;
#define COLOR_core__HashMap__nitc__MModule__nitc__MModuleData___35dE 1
#define COLOR_nitc__mmodule_data__MModuleData___defs 1
...
extern const struct class class_nitc__MModuleMultiData;
...
extern const struct class class_nitc__div_by_zero__DivByZeroPhase;
...
extern const struct class class_nitc__div_by_zero__DivByZeroVisitor;
...
extern const struct class class_nitc__serialization_phase__SerializationPhaseRename;
...
extern const struct class class_nitc__serialization_phase__SerializationPhasePreModel;
...
extern const struct class class_nitc__serialization_phase__SerializationPhasePostModel;
...
extern const struct class class_nitc__InjectedLexer;
...
extern const struct class class_nitc__deriving__DerivingPhase;
...
extern const struct class class_nitc__check_annotation__CheckAnnotationPhase;
#define COLOR_nitc__check_annotation__CheckAnnotationPhase___primtives_annotations_list 7
extern const struct type type_core__HashSet__core__String;
extern const char FILE_nitc__check_annotation[];
#define COLOR_nitc__check_annotation__CheckAnnotationPhase___primtives_annotations 8
extern const struct type type_core__HashMap__nitc__MModule__core__HashSet__core__String;
#define COLOR_nitc__check_annotation__CheckAnnotationPhase___user_annotations 9
...
extern const struct class class_nitc__glsl_validation__GLSLValidationPhase;
...
extern const struct class class_nitc__parallelization_phase__ParallelizationPhase;
...
extern const struct class class_nitc__i18n_phase__I18NPhase;
...
extern const struct class class_nitc__i18n_phase__StringFinder;
extern const struct type type_core__HashMap__core__String__nitc__PObject;
#define COLOR_nitc__i18n_phase__StringFinder___strings 1
...
extern const struct class class_nitc__PObject;
...
extern const struct class class_nitc__regex_phase__RegexVisitor;
...
extern const struct class class_nitc__CFunction;
...
#define COLOR_csv__CsvDocument___records 4
...
extern const struct class class_nitc__GlobalCompilerPhase;
...
extern const struct class class_nitc__GlobalCompiler;
...
extern const struct class class_nitc__GlobalCompilerVisitor;
...
extern const struct class class_nitc__global_compiler__CustomizedRuntimeFunction;
...
#define COLOR_nitc__light_ffi_base__FFILanguage__ffi_language_assignation_phase_61d 15
#define COLOR_nitc__light_c__FFILanguageAssignationPhase___c_language 5
val* NEW_nitc__CPPLanguage(const struct type* type);
extern const struct type type_nitc__CPPLanguage;
#define COLOR_nitc__cpp__FFILanguageAssignationPhase___cpp_language 6
val* NEW_nitc__ObjCLanguage(const struct type* type);
extern const struct type type_nitc__ObjCLanguage;
#define COLOR_nitc__objc__FFILanguageAssignationPhase___objc_language 8
val* NEW_nitc__JavaLanguage(const struct type* type);
extern const struct type type_nitc__JavaLanguage;
#define COLOR_nitc__java__FFILanguageAssignationPhase___java_language 7
...
extern const struct class class_nitc__VerifyNitniCallbacksPhase;
...
extern const struct class class_nitc__ForeignCallbackSet;
extern const struct type type_core__HashSet__nitc__MExplicitCall;
#define COLOR_nitc__nitni_callbacks__ForeignCallbackSet___callbacks 0
extern const struct type type_core__HashSet__nitc__MExplicitSuper;
#define COLOR_nitc__nitni_callbacks__ForeignCallbackSet___supers 1
#define COLOR_nitc__nitni_callbacks__ForeignCallbackSet___types 2
extern const struct type type_core__HashSet__nitc__MExplicitCast;
#define COLOR_nitc__nitni_callbacks__ForeignCallbackSet___casts 3
...
extern const struct class class_nitc__MExplicitCall;
...
extern const struct class class_nitc__MExplicitSuper;
...
extern const struct class class_nitc__MExplicitCast;
...
extern const struct class class_json__JsonSerializer;
...
extern const struct class class_serialization__SerializerCache;
val* NEW_serialization__StrictHashMap(const struct type* type);
extern const struct type type_serialization__StrictHashMap__serialization__Serializable__core__Int;
...
extern const struct class class_serialization__StrictHashMap;
...
extern const struct class class_nitc__AndroidPlatform;
...
extern const struct class class_nitc__AndroidToolchain;
...
extern const struct class class_nitc__header_dependency__HeaderDependancyPhase;
void nitc___nitc__PkgconfigPhase___nitc__phase__Phase__process_annotated_node(val* self, val* p0, val* p1);
extern const struct class class_nitc__PkgconfigPhase;
...
extern const struct class class_nitc__c_compiler_options__CCompilerOptionsPhase;
...
extern const struct class class_nitc__DirectCCompilerOption;
...
extern const struct class class_nitc__ExecCCompilerOption;
...
extern const struct class class_nitc__CPPLanguage;
val* nitc___nitc__CPPCompilationUnit___write_to_files(val* self, val* p0, val* p1);
extern const struct class class_nitc__CPPCompilationUnit;
...
extern const struct class class_nitc__ExternCppFile;
...
extern const struct class class_nitc__JavaLanguage;
...
extern const struct class class_nitc__JavaClassTemplate;
#define COLOR_nitc__java__JavaClassTemplate___header 5
#define COLOR_nitc__java__JavaClassTemplate___class_content 6
...
extern const struct class class_nitc__java__ToJavaCallContext;
...
extern const struct class class_nitc__java__FromJavaCallContext;
...
extern const struct class class_nitc__ForeignJavaType;
...
extern const struct class class_nitc__extra_java_files__JavaExtraFilesPhase;
...
extern const struct class class_nitc__ObjCLanguage;
val* nitc__objc___nitc__objc__ObjCCompilationUnit___write_to_files(val* self, val* p0, val* p1);
extern const struct class class_nitc__objc__ObjCCompilationUnit;
...
extern const struct class class_nitc__ExternObjCFile;
...
extern const struct class class_nitc__ForeignObjCType;
...
extern const struct class class_nitc__objc__FromObjCCallContext;
...
extern const struct class class_nitc__AndroidProject;
#define COLOR_nitc__app_annotations__AppProject___version 6
#define COLOR_nitc__app_annotations__AppProject___files 9
...
extern const struct class class_nitc__PnaclPlatform;
...
extern const struct class class_nitc__PnaclToolchain;
...
extern const struct class class_nitc__EmscriptenPlatform;
...
extern const struct class class_nitc__EnscriptenToolchain;
...
extern const struct class class_nitc__ios__IOSPlatform;
val* nitc__ios___nitc__ios__IosProject___nitc__app_annotations__AppProject__namespace(val* self);
extern const struct class class_nitc__ios__IosProject;
...
extern const struct class class_nitc__ios__IOSToolchain;
...
extern const struct class class_nitc__PbxUUIDGenerator;
#define COLOR_nitc__xcode_templates__PbxUUIDGenerator___seed 0
...
extern const struct class class_nitc__PbxFile;
...
extern const struct class class_nitc__PbxprojectTemplate;
extern const struct type type_core__Array__nitc__PbxFile;
#define COLOR_nitc__xcode_templates__PbxprojectTemplate___source_files 5
#define COLOR_nitc__xcode_templates__PbxprojectTemplate___asset_files 6
#define COLOR_nitc__xcode_templates__PbxprojectTemplate___files 7
...
extern const struct class class_nitc__PlistTemplate;
...
extern const struct class class_nitc__LaunchScreenStoryboardTemplate;
#define COLOR_nitc__xcode_templates__LaunchScreenStoryboardTemplate___title 4
#define COLOR_nitc__xcode_templates__LaunchScreenStoryboardTemplate___subtitle 5
