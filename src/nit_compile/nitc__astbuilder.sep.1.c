...
var_variable = var20;
{
var24 = ((val*(*)(val* self))(self->class->vft[COLOR_nitc__typing__AExpr__mtype]))(self); /* mtype on <self:AExpr>*/
}
{
{ /* Inline typing#Variable#declared_type= (var_variable,var24) on <var_variable:nullable Variable(Variable)> */
var_variable->attrs[COLOR_nitc__typing__Variable___declared_type].val = var24; /* _declared_type on <var_variable:nullable Variable(Variable)> */
RET_LABEL25:(void)0;
}
}
var26 = NEW_nitc__AVarAssignExpr(&type_nitc__AVarAssignExpr);
{
nitc__astbuilder___AVarAssignExpr___make(var26, var_variable, self); /* Direct call astbuilder#AVarAssignExpr#make on <var26:AVarAssignExpr>*/
}
var_nvar = var26;
{
...
var28 = NEW_nitc__AVarExpr(&type_nitc__AVarExpr);
{
{ /* Inline typing#Variable#declared_type (var_variable) on <var_variable:nullable Variable(Variable)> */
var31 = var_variable->attrs[COLOR_nitc__typing__Variable___declared_type].val; /* _declared_type on <var_variable:nullable Variable(Variable)> */
var29 = var31;
RET_LABEL30:(void)0;
}
}
...
{
nitc__astbuilder___AVarExpr___make(var28, var_variable, var29); /* Direct call astbuilder#AVarExpr#make on <var28:AVarExpr>*/
}
var = var28;
goto RET_LABEL;
RET_LABEL:;
...
{
var6 = core__abstract_text___Object___inspect(self);
}
...
varonce = var1;
{
core__file___Sys___print(var, var7); /* Direct call file#Sys#print on <var:Sys>*/
}
