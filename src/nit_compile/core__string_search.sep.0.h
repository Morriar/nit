...
#define COLOR_core__string_search__Pattern__search_in 24
...
#define COLOR_core__string_search__Pattern__search_index_in 25
...
#define COLOR_core___core__Match___core__kernel__Object__init 23
...
#define COLOR_core__string_search__Pattern__is_in 26
