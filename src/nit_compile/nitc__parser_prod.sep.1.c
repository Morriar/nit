...
var = self->attrs[COLOR_nitc__parser_nodes__AModule___n_moduledecl].val; /* _n_moduledecl on <self:AModule> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var); /* enter_visit on <var_v:Visitor>*/
}
{
{ /* Inline parser_nodes#AModule#n_imports (self) on <self:AModule> */
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var1); /* enter_visit on <var_v:Visitor>*/
}
var2 = self->attrs[COLOR_nitc__parser_nodes__ADefinition___n_visibility].val; /* _n_visibility on <self:AModuledecl> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var2); /* enter_visit on <var_v:Visitor>*/
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var3); /* enter_visit on <var_v:Visitor>*/
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var4); /* enter_visit on <var_v:Visitor>*/
}
var5 = self->attrs[COLOR_nitc__parser_nodes__Prod___n_annotations].val; /* _n_annotations on <self:AModuledecl> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var5); /* enter_visit on <var_v:Visitor>*/
}
RET_LABEL:;
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var9); /* enter_visit on <var_v:Visitor>*/
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var10); /* enter_visit on <var_v:Visitor>*/
}
{
{ /* Inline parser_nodes#AClassdef#n_propdefs (self) on <self:AStdClassdef> */
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var14); /* enter_visit on <var_v:Visitor>*/
}
RET_LABEL:;
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var6); /* enter_visit on <var_v:Visitor>*/
}
var7 = self->attrs[COLOR_nitc__parser_nodes__AAttrPropdef___n_expr].val; /* _n_expr on <self:AAttrPropdef> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var7); /* enter_visit on <var_v:Visitor>*/
}
var8 = self->attrs[COLOR_nitc__parser_nodes__Prod___n_annotations].val; /* _n_annotations on <self:AAttrPropdef> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var8); /* enter_visit on <var_v:Visitor>*/
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var11); /* enter_visit on <var_v:Visitor>*/
}
RET_LABEL:;
}
...
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var12); /* enter_visit on <var_v:Visitor>*/
}
var13 = self->attrs[COLOR_nitc__parser_nodes__AMethPropdef___n_kwend].val; /* _n_kwend on <self:AMethPropdef> */
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var13); /* enter_visit on <var_v:Visitor>*/
}
RET_LABEL:;
}
