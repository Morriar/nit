...
#define COLOR_nitc__location__SourceFile___stream 3
#define COLOR_nitc___nitc__SourceFile___core__kernel__Object__init 29
...
#define COLOR_nitc__location__Location___text_cache 5
...
#define COLOR_nitc___nitc__Location___core__kernel__Object__init 44
