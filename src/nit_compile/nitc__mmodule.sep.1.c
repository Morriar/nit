...
var24 = var_mgroup->attrs[COLOR_nitc__mpackage__MGroup___mpackage].val; /* _mpackage on <var_mgroup:nullable MGroup(MGroup)> */
...
{
{ /* Inline mpackage#MPackage#name (var22) on <var22:MPackage> */
var27 = var22->attrs[COLOR_nitc__mpackage__MPackage___name].val; /* _name on <var22:MPackage> */
...
((struct instance_core__NativeArray*)var17)->values[0]=var25;
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var30 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
((struct instance_core__NativeArray*)var17)->values[2]=var28;
{
var31 = ((val*(*)(val* self))(var17->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var17); /* native_to_s on <var17:NativeArray[String]>*/
}
varonce = var17;
var3 = var31;
goto RET_LABEL4;
...
{
var37 = ((val*(*)(val* self, val* p0))(var33->class->vft[COLOR_core__abstract_text__Text___43d]))(var33, var34); /* + on <var33:String>*/
}
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var40 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
{
var41 = core___core__Text___to_cmangle(var38);
}
{
var42 = ((val*(*)(val* self, val* p0))(var37->class->vft[COLOR_core__abstract_text__Text___43d]))(var37, var41); /* + on <var37:Text(String)>*/
}
var_res = var42;
} else {
{
{ /* Inline mmodule#MModule#name (self) on <self:MModule> */
var45 = self->attrs[COLOR_nitc__mmodule__MModule___name].val; /* _name on <self:MModule> */
...
{
var46 = core___core__Text___to_cmangle(var43);
}
var_res = var46;
}
var3 = var_res;
...
var77 = core__abstract_text___CString___to_s_full(var76, 16l, 16l);
var75 = var77;
varonce74 = var75;
}
...
((struct instance_core__NativeArray*)var73)->values[3]=var79;
} else {
var73 = varonce;
varonce = NULL;
}
{
var82 = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_text__Object__to_s]))(self); /* to_s on <self:MModule>*/
}
((struct instance_core__NativeArray*)var73)->values[0]=var82;
{
var83 = ((val*(*)(val* self))(var_m->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_m); /* to_s on <var_m:MModule>*/
}
((struct instance_core__NativeArray*)var73)->values[2]=var83;
{
var84 = ((val*(*)(val* self))(var_v->class->vft[COLOR_core__abstract_text__Object__to_s]))(var_v); /* to_s on <var_v:MVisibility>*/
}
((struct instance_core__NativeArray*)var73)->values[4]=var84;
{
var85 = ((val*(*)(val* self))(var73->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var73); /* native_to_s on <var73:NativeArray[String]>*/
}
varonce = var73;
{
core__file___Sys___print(var72, var85); /* Direct call file#Sys#print on <var72:Sys>*/
}
...
val* nitc___nitc__MModule___nitc__model_base__MConcern__parent_concern(val* self) {
