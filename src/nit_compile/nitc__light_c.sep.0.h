...
extern const struct type type_nitc__ExternCFunction;
...
extern const struct type type_nitc__ForeignCType;
#define COLOR_nitc__light_c__ForeignCType__ctype_61d 16
...
#define COLOR_nitc___nitc__ForeignCType___core__kernel__Object__init 17
...
#define COLOR_nitc__c_tools__CFunction__signature_61d 15
val* NEW_nitc__FromCCallContext(const struct type* type);
extern const struct type type_nitc__FromCCallContext;
