...
/* method lexer_work#Token#text= for (self: Token, String) */
void nitc__lexer_work___Token___text_61d(val* self, val* p0) {
val* var_text /* var text: String */;
var_text = p0;
self->attrs[COLOR_nitc__lexer_work__Token___cached_text].val = var_text; /* _cached_text on <self:Token> */
RET_LABEL:;
}
...
{
var7 = ((val*(*)(val* self))(self->class->vft[COLOR_nitc__lexer_work__Lexer__get_token]))(self); /* get_token on <self:Lexer>*/
}
var_t = var7;
for(;;) {
if (var_t == NULL) {
...
if (var8){
{
var15 = ((val*(*)(val* self))(self->class->vft[COLOR_nitc__lexer_work__Lexer__get_token]))(self); /* get_token on <self:Lexer>*/
}
var_t = var15;
} else {
goto BREAK_label;
...
val* var353 /* : EOF */;
val* var_token354 /* var token: EOF */;
var_dfa_state = 0l;
...
var342 = NEW_core__NativeArray(3l, &type_core__NativeArray__core__String);
if (likely(varonce343!=NULL)) {
var344 = varonce343;
} else {
var345 = "Syntax Error: unknown token `";
var346 = core__abstract_text___CString___to_s_full(var345, 29l, 29l);
var344 = var346;
varonce343 = var344;
}
...
var349 = "`.";
var350 = core__abstract_text___CString___to_s_full(var349, 2l, 2l);
var348 = var350;
varonce347 = var348;
}
((struct instance_core__NativeArray*)var342)->values[2]=var348;
} else {
var342 = varonce;
varonce = NULL;
}
...
{
var351 = ((val*(*)(val* self))(var342->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var342); /* native_to_s on <var342:NativeArray[String]>*/
}
varonce = var342;
{
nitc__lexer_work___ALexerError___init_lexer_error(var341, var351, var_location325, var_text); /* Direct call lexer_work#ALexerError#init_lexer_error on <var341:ALexerError>*/
}
var_token = var341;
{
...
var353 = NEW_nitc__EOF(&type_nitc__EOF);
{
nitc__lexer_work___EOF___init_tk(var353, var_location325); /* Direct call lexer_work#EOF#init_tk on <var353:EOF>*/
}
var_token354 = var353;
{
{ /* Inline parser_nodes#SourceFile#last_token= (var_file,var_token354) on <var_file:SourceFile> */
var_file->attrs[COLOR_nitc__parser_nodes__SourceFile___last_token].val = var_token354; /* _last_token on <var_file:SourceFile> */
RET_LABEL355:(void)0;
}
}
var = var_token354;
