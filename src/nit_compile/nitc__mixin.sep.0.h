...
#define COLOR_nitc__mixin__ToolContext___opt_mixins 112
extern const char FILE_nitc__mixin[];
#define COLOR_nitc__mixin__ToolContext___opt_defines 113
#define COLOR_nitc__mixin___ToolContext___core__kernel__Object__init 176
...
#define COLOR_nitc__mixin___ToolContext___make_main_module 165
