...
/* runtime class nitc__no_warning__NoWarningPhase: nitc::no_warning::NoWarningPhase (dead=false; need_corpse=false)*/
const struct class class_nitc__no_warning__NoWarningPhase = {
0, /* box_kind */
{
(nitmethod_t)nitc___nitc__Phase___core__kernel__Object__init, /* pointer to no_warning:NoWarningPhase:phase#Phase#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to no_warning:NoWarningPhase:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to no_warning:NoWarningPhase:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to no_warning:NoWarningPhase:kernel#Object#== */
(nitmethod_t)nitc___nitc__Phase___core__abstract_text__Object__to_s, /* pointer to no_warning:NoWarningPhase:phase#Phase#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to no_warning:NoWarningPhase:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to no_warning:NoWarningPhase:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to no_warning:NoWarningPhase:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to no_warning:NoWarningPhase:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to no_warning:NoWarningPhase:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to no_warning:NoWarningPhase:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to no_warning:NoWarningPhase:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to no_warning:NoWarningPhase:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to no_warning:NoWarningPhase:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to no_warning:NoWarningPhase:serialization#Object#is_same_serialized */
(nitmethod_t)nitc___nitc__Phase___toolcontext_61d, /* pointer to no_warning:NoWarningPhase:phase#Phase#toolcontext= */
(nitmethod_t)nitc___nitc__Phase___depends_61d, /* pointer to no_warning:NoWarningPhase:phase#Phase#depends= */
(nitmethod_t)nitc___nitc__Phase___toolcontext, /* pointer to no_warning:NoWarningPhase:phase#Phase#toolcontext */
(nitmethod_t)nitc___nitc__Phase___in_hierarchy_61d, /* pointer to no_warning:NoWarningPhase:phase#Phase#in_hierarchy= */
(nitmethod_t)nitc___nitc__Phase___depends, /* pointer to no_warning:NoWarningPhase:phase#Phase#depends */
(nitmethod_t)nitc___nitc__Phase___disabled, /* pointer to no_warning:NoWarningPhase:phase#Phase#disabled */
(nitmethod_t)nitc__modelbuilder___Phase___process_mainmodule, /* pointer to no_warning:NoWarningPhase:modelbuilder#Phase#process_mainmodule */
(nitmethod_t)nitc__no_warning___nitc__no_warning__NoWarningPhase___nitc__phase__Phase__process_nmodule, /* pointer to no_warning:NoWarningPhase:no_warning#NoWarningPhase#process_nmodule */
(nitmethod_t)nitc___nitc__Phase___process_nclassdef, /* pointer to no_warning:NoWarningPhase:phase#Phase#process_nclassdef */
(nitmethod_t)nitc___nitc__Phase___process_annotated_node, /* pointer to no_warning:NoWarningPhase:phase#Phase#process_annotated_node */
(nitmethod_t)nitc___nitc__Phase___process_npropdef, /* pointer to no_warning:NoWarningPhase:phase#Phase#process_npropdef */
(nitmethod_t)nitc___nitc__Phase___in_hierarchy, /* pointer to no_warning:NoWarningPhase:phase#Phase#in_hierarchy */
(nitmethod_t)nitc___nitc__Phase___disabled_61d, /* pointer to no_warning:NoWarningPhase:phase#Phase#disabled= */
(nitmethod_t)core___core__Object___init, /* pointer to no_warning:NoWarningPhase:kernel#Object#init */
}
};
/* allocate NoWarningPhase */
val* NEW_nitc__no_warning__NoWarningPhase(const struct type* type) {
val* self /* : NoWarningPhase */;
self = nit_alloc(sizeof(struct instance) + 4*sizeof(nitattribute_t));
self->type = type;
self->class = &class_nitc__no_warning__NoWarningPhase;
self->attrs[COLOR_nitc__phase__Phase___disabled].s = 0; /* _disabled on <self:NoWarningPhase exact> */
return self;
}
...
(nitmethod_t)core___core__Object___output, /* pointer to modelbuilder_base:ModelBuilder:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to modelbuilder_base:ModelBuilder:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to modelbuilder_base:ModelBuilder:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__global_compiler___ModelBuilder___run_global_compiler, /* pointer to modelbuilder_base:ModelBuilder:global_compiler#ModelBuilder#run_global_compiler */
...
(nitmethod_t)nitc__compiler_serialization___ModelBuilder___write_and_make, /* pointer to modelbuilder_base:ModelBuilder:compiler_serialization#ModelBuilder#write_and_make */
...
(nitmethod_t)nitc__compiler_serialization___ModelBuilder___write_poset_to_file, /* pointer to modelbuilder_base:ModelBuilder:compiler_serialization#ModelBuilder#write_poset_to_file */
...
(nitmethod_t)nitc__annotation___ModelBuilder___lookup_annotation_on_modules, /* pointer to modelbuilder_base:ModelBuilder:annotation#ModelBuilder#lookup_annotation_on_modules */
(nitmethod_t)nitc__annotation___ModelBuilder___collect_annotations_on_modules, /* pointer to modelbuilder_base:ModelBuilder:annotation#ModelBuilder#collect_annotations_on_modules */
...
(nitmethod_t)nitc__annotation___ModelBuilder___collect_annotations_data, /* pointer to modelbuilder_base:ModelBuilder:annotation#ModelBuilder#collect_annotations_data */
...
(nitmethod_t)nitc__annotation___ModelBuilder___collect_annotations_data_cache, /* pointer to modelbuilder_base:ModelBuilder:annotation#ModelBuilder#collect_annotations_data_cache */
(nitmethod_t)nitc__annotation___ModelBuilder___get_mmodule_annotation, /* pointer to modelbuilder_base:ModelBuilder:annotation#ModelBuilder#get_mmodule_annotation */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MClassDefSorter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MClassDefSorter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MClassDefSorter:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MPropDefSorter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MPropDefSorter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MPropDefSorter:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MClass:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MClass:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MClass:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__extern_classes___MClass___ftype, /* pointer to model:MClass:extern_classes#MClass#ftype */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MClassDef:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MClassDef:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MClassDef:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MClassType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MClassType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MClassType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MClassType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MClassType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MClassType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MClassType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MClassType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MClassType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MClassType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__nitni_base___MType___cname_normal_class, /* pointer to model:MClassType:nitni_base#MType#cname_normal_class */
(nitmethod_t)nitc__java___MClassType___MType__jni_signature_alt, /* pointer to model:MClassType:java#MClassType#jni_signature_alt */
(nitmethod_t)nitc__java___MClassType___MType__jni_type, /* pointer to model:MClassType:java#MClassType#jni_type */
(nitmethod_t)nitc__java___MClassType___MType__jni_format, /* pointer to model:MClassType:java#MClassType#jni_format */
(nitmethod_t)nitc__java___MClassType___MType__java_type, /* pointer to model:MClassType:java#MClassType#java_type */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MClassType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MClassType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MClassType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MClassType:java#MType#java_type */
}
};
/* allocate MClassType */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MGenericType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MGenericType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MGenericType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MGenericType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MGenericType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MGenericType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MGenericType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MGenericType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MGenericType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MGenericType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__nitni_base___MType___cname_normal_class, /* pointer to model:MGenericType:nitni_base#MType#cname_normal_class */
(nitmethod_t)nitc__java___MClassType___MType__jni_signature_alt, /* pointer to model:MGenericType:java#MClassType#jni_signature_alt */
(nitmethod_t)nitc__java___MClassType___MType__jni_type, /* pointer to model:MGenericType:java#MClassType#jni_type */
(nitmethod_t)nitc__java___MClassType___MType__jni_format, /* pointer to model:MGenericType:java#MClassType#jni_format */
(nitmethod_t)nitc__java___MClassType___MType__java_type, /* pointer to model:MGenericType:java#MClassType#java_type */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MGenericType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MGenericType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MGenericType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MGenericType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MVirtualType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MVirtualType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MVirtualType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MVirtualType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MVirtualType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MVirtualType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MVirtualType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MVirtualType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MVirtualType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MVirtualType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MVirtualType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MVirtualType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MVirtualType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MVirtualType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MParameterType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MParameterType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MParameterType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MParameterType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MParameterType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MParameterType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MParameterType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MParameterType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MParameterType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MParameterType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MParameterType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MParameterType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MParameterType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MParameterType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MNullableType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MNullableType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MNullableType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MNullableType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MNullableType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MNullableType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MNullableType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MNullableType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MNullableType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MNullableType___MType__compile_extern_helper_functions, /* pointer to model:MNullableType:compiler_ffi#MNullableType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MNullableType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MNullableType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MNullableType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MNullableType:java#MType#java_type */
...
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MNullableType:compiler_ffi#MType#compile_extern_helper_functions */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MNotNullType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MNotNullType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MNotNullType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MNotNullType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MNotNullType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MNotNullType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MNotNullType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MNotNullType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MNotNullType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MNotNullType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MNotNullType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MNotNullType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MNotNullType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MNotNullType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MNullType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MNullType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MNullType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MNullType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MNullType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MNullType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MNullType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MNullType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MNullType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MNullType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MNullType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MNullType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MNullType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MNullType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MBottomType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MBottomType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MBottomType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MBottomType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MBottomType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MBottomType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MBottomType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MBottomType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MBottomType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MBottomType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MBottomType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MBottomType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MBottomType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MBottomType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MErrorType:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MErrorType:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MErrorType:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MErrorType:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MErrorType:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MErrorType:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MErrorType:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MErrorType:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MErrorType:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MErrorType:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MErrorType:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MErrorType:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MErrorType:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MErrorType:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MSignature:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MSignature:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MSignature:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__c___NitniCallback___compile_callback_to_c, /* pointer to model:MSignature:c#NitniCallback#compile_callback_to_c */
(nitmethod_t)nitc__cpp___NitniCallback___compile_callback_to_cpp, /* pointer to model:MSignature:cpp#NitniCallback#compile_callback_to_cpp */
(nitmethod_t)nitc__objc___NitniCallback___compile_callback_to_objc, /* pointer to model:MSignature:objc#NitniCallback#compile_callback_to_objc */
(nitmethod_t)nitc__java___MType___NitniCallback__compile_callback_to_java, /* pointer to model:MSignature:java#MType#compile_callback_to_java */
(nitmethod_t)nitc__java___MType___NitniCallback__jni_methods_declaration, /* pointer to model:MSignature:java#MType#jni_methods_declaration */
...
(nitmethod_t)nitc__light___MType___compile_extern_type, /* pointer to model:MSignature:light#MType#compile_extern_type */
(nitmethod_t)nitc__compiler_ffi___MType___compile_extern_helper_functions, /* pointer to model:MSignature:compiler_ffi#MType#compile_extern_helper_functions */
...
(nitmethod_t)nitc__java___MType___jni_signature_alt, /* pointer to model:MSignature:java#MType#jni_signature_alt */
(nitmethod_t)nitc__java___MType___jni_type, /* pointer to model:MSignature:java#MType#jni_type */
(nitmethod_t)nitc__java___MType___jni_format, /* pointer to model:MSignature:java#MType#jni_format */
(nitmethod_t)nitc__java___MType___java_type, /* pointer to model:MSignature:java#MType#java_type */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MParameter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MParameter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MParameter:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MMethod:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MMethod:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MMethod:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc__nitni_utilities___MMethod___build_ccall, /* pointer to model:MMethod:nitni_utilities#MMethod#build_ccall */
(nitmethod_t)nitc__java___MMethod___build_c_implementation_signature, /* pointer to model:MMethod:java#MMethod#build_c_implementation_signature */
(nitmethod_t)nitc__java___MMethod___build_jni_format, /* pointer to model:MMethod:java#MMethod#build_jni_format */
}
};
/* allocate MMethod */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MAttribute:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MAttribute:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MAttribute:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MVirtualTypeProp:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MVirtualTypeProp:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MVirtualTypeProp:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MMethodDef:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MMethodDef:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MMethodDef:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MAttributeDef:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MAttributeDef:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MAttributeDef:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MVirtualTypeDef:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MVirtualTypeDef:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MVirtualTypeDef:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model:MClassKind:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model:MClassKind:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model:MClassKind:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to mmodule:MModule:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to mmodule:MModule:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to mmodule:MModule:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc___nitc__MModule___nitc__model_base__MConcern__parent_concern, /* pointer to mmodule:MModule:mmodule#MModule#parent_concern */
...
(nitmethod_t)nitc__objc___MModule___objc_imported_headers, /* pointer to mmodule:MModule:objc#MModule#objc_imported_headers */
(nitmethod_t)nitc__objc___MModule___has_public_objc_header, /* pointer to mmodule:MModule:objc#MModule#has_public_objc_header */
...
(nitmethod_t)nitc__header_dependency___MModule___compute_header_dependencies, /* pointer to mmodule:MModule:header_dependency#MModule#compute_header_dependencies */
...
(nitmethod_t)nitc__cpp___MModule___cppflags, /* pointer to mmodule:MModule:cpp#MModule#cppflags */
(nitmethod_t)nitc__extra_java_files___MModule___extra_java_files, /* pointer to mmodule:MModule:extra_java_files#MModule#extra_java_files */
(nitmethod_t)nitc__extra_java_files___MModule___extra_java_files_61d, /* pointer to mmodule:MModule:extra_java_files#MModule#extra_java_files= */
...
(nitmethod_t)nitc__header_dependency___MModule___header_dependencies, /* pointer to mmodule:MModule:header_dependency#MModule#header_dependencies */
(nitmethod_t)nitc__header_dependency___MModule___header_dependencies_61d, /* pointer to mmodule:MModule:header_dependency#MModule#header_dependencies= */
(nitmethod_t)nitc__ffi_base___MModule___ffi_callbacks, /* pointer to mmodule:MModule:ffi_base#MModule#ffi_callbacks */
...
(nitmethod_t)nitc__java___MModule___java_file, /* pointer to mmodule:MModule:java#MModule#java_file */
...
(nitmethod_t)nitc__compiler_ffi___MModule___finalize_ffi, /* pointer to mmodule:MModule:compiler_ffi#MModule#finalize_ffi */
(nitmethod_t)nitc__light_ffi___MModule___uses_ffi, /* pointer to mmodule:MModule:light_ffi#MModule#uses_ffi */
(nitmethod_t)nitc__compiler_ffi___MModule___compiled_callbacks, /* pointer to mmodule:MModule:compiler_ffi#MModule#compiled_callbacks */
...
(nitmethod_t)nitc__ffi___MModule___finalize_ffi_wrapper, /* pointer to mmodule:MModule:ffi#MModule#finalize_ffi_wrapper */
...
(nitmethod_t)nitc__compiler_ffi___MModule___check_callback_compilation, /* pointer to mmodule:MModule:compiler_ffi#MModule#check_callback_compilation */
(nitmethod_t)nitc__compiler_ffi___MModule___foreign_callbacks, /* pointer to mmodule:MModule:compiler_ffi#MModule#foreign_callbacks */
...
(nitmethod_t)nitc__cpp___MModule___cpp_file, /* pointer to mmodule:MModule:cpp#MModule#cpp_file */
(nitmethod_t)nitc__cpp___MModule___cpp_file_61d, /* pointer to mmodule:MModule:cpp#MModule#cpp_file= */
(nitmethod_t)nitc__objc___MModule___objc_file, /* pointer to mmodule:MModule:objc#MModule#objc_file */
(nitmethod_t)nitc__objc___MModule___objc_file_61d, /* pointer to mmodule:MModule:objc#MModule#objc_file= */
(nitmethod_t)nitc__objc___MModule___has_public_objc_header_61d, /* pointer to mmodule:MModule:objc#MModule#has_public_objc_header= */
(nitmethod_t)nitc__java___MModule___ensure_java_files, /* pointer to mmodule:MModule:java#MModule#ensure_java_files */
(nitmethod_t)nitc__java___MModule___java_file_61d, /* pointer to mmodule:MModule:java#MModule#java_file= */
(nitmethod_t)nitc__java___MModule___impl_java_class_name, /* pointer to mmodule:MModule:java#MModule#impl_java_class_name */
(nitmethod_t)nitc__java___MModule___callbacks_used_from_java, /* pointer to mmodule:MModule:java#MModule#callbacks_used_from_java */
(nitmethod_t)nitc__java___MModule___insert_compiler_options, /* pointer to mmodule:MModule:java#MModule#insert_compiler_options */
(nitmethod_t)nitc__java___MModule___ensure_linking_callback_methods, /* pointer to mmodule:MModule:java#MModule#ensure_linking_callback_methods */
...
val* var13 /* : MultiHashMap[String, String] */;
val* var14 /* : ForeignCallbackSet */;
val* var15 /* : ForeignCallbackSet */;
val* var17 /* : Array[NitniCallback] */;
self = nit_alloc(sizeof(struct instance) + 79*sizeof(nitattribute_t));
self->type = type;
...
var10 = NEW_core__HashMap(&type_core__HashMap__nitc__FFILanguage__core__Set__nitc__NitniCallback);
{
core___core__HashMap___core__kernel__Object__init(var10); /* Direct call hash_collection#HashMap#init on <var10:HashMap[FFILanguage, Set[NitniCallback]]>*/
}
self->attrs[COLOR_nitc__ffi_base__MModule___ffi_callbacks].val = var10; /* _ffi_callbacks on <self:MModule exact> */
self->attrs[COLOR_nitc__light_ffi__MModule___uses_ffi].s = 0; /* _uses_ffi on <self:MModule exact> */
var11 = NEW_core__HashSet(&type_core__HashSet__nitc__FFILanguage);
{
core___core__HashSet___core__kernel__Object__init(var11); /* Direct call hash_collection#HashSet#init on <var11:HashSet[FFILanguage]>*/
}
self->attrs[COLOR_nitc__light_ffi__MModule___present_languages].val = var11; /* _present_languages on <self:MModule exact> */
var12 = NEW_core__HashSet(&type_core__HashSet__nitc__AMethPropdef);
{
core___core__HashSet___core__kernel__Object__init(var12); /* Direct call hash_collection#HashSet#init on <var12:HashSet[AMethPropdef]>*/
}
self->attrs[COLOR_nitc__light_ffi__MModule___compiled_ffi_methods].val = var12; /* _compiled_ffi_methods on <self:MModule exact> */
var13 = NEW_more_collections__MultiHashMap(&type_more_collections__MultiHashMap__core__String__core__String);
{
core___core__HashMap___core__kernel__Object__init(var13); /* Direct call hash_collection#HashMap#init on <var13:MultiHashMap[String, String]>*/
}
self->attrs[COLOR_nitc__cpp__MModule___cppflags].val = var13; /* _cppflags on <self:MModule exact> */
self->attrs[COLOR_nitc__objc__MModule___has_public_objc_header].s = 0; /* _has_public_objc_header on <self:MModule exact> */
var14 = NEW_nitc__ForeignCallbackSet(&type_nitc__ForeignCallbackSet);
{
{ /* Inline kernel#Object#init (var14) on <var14:ForeignCallbackSet> */
RET_LABEL:(void)0;
}
}
self->attrs[COLOR_nitc__java__MModule___callbacks_used_from_java].val = var14; /* _callbacks_used_from_java on <self:MModule exact> */
var15 = NEW_nitc__ForeignCallbackSet(&type_nitc__ForeignCallbackSet);
{
{ /* Inline kernel#Object#init (var15) on <var15:ForeignCallbackSet> */
RET_LABEL16:(void)0;
}
}
self->attrs[COLOR_nitc__compiler_ffi__MModule___foreign_callbacks].val = var15; /* _foreign_callbacks on <self:MModule exact> */
var17 = NEW_core__Array(&type_core__Array__nitc__NitniCallback);
{
core___core__Array___core__kernel__Object__init(var17); /* Direct call array#Array#init on <var17:Array[NitniCallback]>*/
}
self->attrs[COLOR_nitc__compiler_ffi__MModule___compiled_callbacks].val = var17; /* _compiled_callbacks on <self:MModule exact> */
return self;
}
...
(nitmethod_t)core___core__Object___output, /* pointer to mpackage:MPackage:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to mpackage:MPackage:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to mpackage:MPackage:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc___nitc__MPackage___nitc__model_base__MConcern__parent_concern, /* pointer to mpackage:MPackage:mpackage#MPackage#parent_concern */
...
(nitmethod_t)core___core__Object___output, /* pointer to mpackage:MGroup:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to mpackage:MGroup:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to mpackage:MGroup:serialization#Object#is_same_serialized */
...
(nitmethod_t)nitc___nitc__MGroup___nitc__model_base__MConcern__parent_concern, /* pointer to mpackage:MGroup:mpackage#MGroup#parent_concern */
...
(nitmethod_t)nitc___nitc__MGroup___is_root, /* pointer to mpackage:MGroup:mpackage#MGroup#is_root */
...
(nitmethod_t)core___core__Object___output, /* pointer to model_base:Model:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model_base:Model:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model_base:Model:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to model_base:MVisibility:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to model_base:MVisibility:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to model_base:MVisibility:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to location:SourceFile:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to location:SourceFile:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to location:SourceFile:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to location:Location:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to location:Location:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to location:Location:serialization#Object#is_same_serialized */
...
(nitmethod_t)core__ropes___core__ropes__Concat___core__kernel__Object__output, /* pointer to ropes:Concat:ropes#Concat#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:Concat:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:Concat:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to ropes:Concat:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to ropes:Concat:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to ropes:Concat:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to ropes:Concat:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to ropes:Concat:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to ropes:Concat:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to ropes:Concat:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to ropes:Concat:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to ropes:Concat:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__String___Text__to_camel_case, /* pointer to ropes:Concat:abstract_text#String#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to ropes:Concat:abstract_text#Text#is_upper */
(nitmethod_t)core__ropes___core__ropes__Concat___core__abstract_text__Text__iterator, /* pointer to ropes:Concat:ropes#Concat#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to ropes:Concat:string_search#Text#has */
...
(nitmethod_t)core__file___String___rmdir, /* pointer to ropes:Concat:file#String#rmdir */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:RopeCharIteratorPiece:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:RopeCharIteratorPiece:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:RopeCharIteratorPiece:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:RopeCharReverseIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:RopeCharReverseIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:RopeCharReverseIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:RopeCharIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:RopeCharIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:RopeCharIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:ReverseRopeSubstrings:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:ReverseRopeSubstrings:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:ReverseRopeSubstrings:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:RopeSubstrings:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:RopeSubstrings:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:RopeSubstrings:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ropes:RopeChars:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ropes:RopeChars:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ropes:RopeChars:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to ropes:RopeChars:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to ropes:RopeChars:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatSubstringsIter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatSubstringsIter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatSubstringsIter:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__FlatString___core__kernel__Object__output, /* pointer to flat:FlatString:flat#FlatString#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatString:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatString:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to flat:FlatString:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to flat:FlatString:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to flat:FlatString:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to flat:FlatString:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to flat:FlatString:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to flat:FlatString:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to flat:FlatString:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to flat:FlatString:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to flat:FlatString:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__String___Text__to_camel_case, /* pointer to flat:FlatString:abstract_text#String#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to flat:FlatString:abstract_text#Text#is_upper */
(nitmethod_t)core___core__Text___iterator, /* pointer to flat:FlatString:abstract_text#Text#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to flat:FlatString:string_search#Text#has */
...
(nitmethod_t)core__file___String___rmdir, /* pointer to flat:FlatString:file#String#rmdir */
...
(nitmethod_t)core___core__FlatString___core__kernel__Object__output, /* pointer to flat:UnicodeFlatString:flat#FlatString#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:UnicodeFlatString:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:UnicodeFlatString:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to flat:UnicodeFlatString:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to flat:UnicodeFlatString:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to flat:UnicodeFlatString:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to flat:UnicodeFlatString:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to flat:UnicodeFlatString:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to flat:UnicodeFlatString:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to flat:UnicodeFlatString:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to flat:UnicodeFlatString:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to flat:UnicodeFlatString:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__String___Text__to_camel_case, /* pointer to flat:UnicodeFlatString:abstract_text#String#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to flat:UnicodeFlatString:abstract_text#Text#is_upper */
(nitmethod_t)core___core__Text___iterator, /* pointer to flat:UnicodeFlatString:abstract_text#Text#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to flat:UnicodeFlatString:string_search#Text#has */
...
(nitmethod_t)core__file___String___rmdir, /* pointer to flat:UnicodeFlatString:file#String#rmdir */
...
(nitmethod_t)core___core__FlatString___core__kernel__Object__output, /* pointer to flat:ASCIIFlatString:flat#FlatString#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:ASCIIFlatString:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:ASCIIFlatString:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to flat:ASCIIFlatString:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to flat:ASCIIFlatString:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to flat:ASCIIFlatString:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to flat:ASCIIFlatString:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to flat:ASCIIFlatString:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to flat:ASCIIFlatString:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to flat:ASCIIFlatString:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to flat:ASCIIFlatString:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to flat:ASCIIFlatString:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__String___Text__to_camel_case, /* pointer to flat:ASCIIFlatString:abstract_text#String#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to flat:ASCIIFlatString:abstract_text#Text#is_upper */
(nitmethod_t)core___core__Text___iterator, /* pointer to flat:ASCIIFlatString:abstract_text#Text#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to flat:ASCIIFlatString:string_search#Text#has */
...
(nitmethod_t)core__file___String___rmdir, /* pointer to flat:ASCIIFlatString:file#String#rmdir */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatStringCharReverseIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatStringCharReverseIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatStringCharReverseIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatStringCharIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatStringCharIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatStringCharIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatStringCharView:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatStringCharView:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatStringCharView:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to flat:FlatStringCharView:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to flat:FlatStringCharView:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core___core__FlatText___core__kernel__Object__output, /* pointer to flat:FlatBuffer:abstract_text#FlatText#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatBuffer:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatBuffer:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to flat:FlatBuffer:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to flat:FlatBuffer:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to flat:FlatBuffer:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to flat:FlatBuffer:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to flat:FlatBuffer:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to flat:FlatBuffer:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to flat:FlatBuffer:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to flat:FlatBuffer:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to flat:FlatBuffer:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__Buffer___Text__to_camel_case, /* pointer to flat:FlatBuffer:abstract_text#Buffer#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to flat:FlatBuffer:abstract_text#Text#is_upper */
(nitmethod_t)core___core__Text___iterator, /* pointer to flat:FlatBuffer:abstract_text#Text#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to flat:FlatBuffer:string_search#Text#has */
...
(nitmethod_t)core___core__Buffer___camel_case, /* pointer to flat:FlatBuffer:abstract_text#Buffer#camel_case */
...
(nitmethod_t)core___core__FlatBuffer___core__abstract_text__Buffer__remove_at, /* pointer to flat:FlatBuffer:flat#FlatBuffer#remove_at */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatBufferCharReverseIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatBufferCharReverseIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatBufferCharReverseIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatBufferCharView:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatBufferCharView:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatBufferCharView:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to flat:FlatBufferCharView:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to flat:FlatBufferCharView:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to flat:FlatBufferCharView:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to flat:FlatBufferCharView:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to flat:FlatBufferCharView:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to flat:FlatBufferCharView:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to flat:FlatBufferCharView:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core__collection___Sequence___subarray, /* pointer to flat:FlatBufferCharView:collection#Sequence#subarray */
...
(nitmethod_t)core___core__Object___output, /* pointer to flat:FlatBufferCharIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to flat:FlatBufferCharIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to flat:FlatBufferCharIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_text:Buffer:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_text:Buffer:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_text:Buffer:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to abstract_text:Buffer:string_search#Pattern#is_in */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to abstract_text:Buffer:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Text___Serializable__accept_json_serializer, /* pointer to abstract_text:Buffer:serialization_write#Text#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to abstract_text:Buffer:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to abstract_text:Buffer:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to abstract_text:Buffer:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Text___to_re, /* pointer to abstract_text:Buffer:re#Text#to_re */
(nitmethod_t)core__string_search___Text___search, /* pointer to abstract_text:Buffer:string_search#Text#search */
...
(nitmethod_t)nitc__i18n_phase___core__Text___escape_to_gettext, /* pointer to abstract_text:Buffer:i18n_phase#Text#escape_to_gettext */
...
(nitmethod_t)core___core__Buffer___Text__to_camel_case, /* pointer to abstract_text:Buffer:abstract_text#Buffer#to_camel_case */
...
(nitmethod_t)core___core__Text___is_upper, /* pointer to abstract_text:Buffer:abstract_text#Text#is_upper */
(nitmethod_t)core___core__Text___iterator, /* pointer to abstract_text:Buffer:abstract_text#Text#iterator */
(nitmethod_t)core__string_search___Text___has, /* pointer to abstract_text:Buffer:string_search#Text#has */
...
(nitmethod_t)core___core__Buffer___camel_case, /* pointer to abstract_text:Buffer:abstract_text#Buffer#camel_case */
(nitmethod_t)core___core__Buffer___upper, /* pointer to abstract_text:Buffer:abstract_text#Buffer#upper */
(nitmethod_t)core___core__Buffer___remove_at, /* pointer to abstract_text:Buffer:abstract_text#Buffer#remove_at */
}
};
/* allocate Buffer */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_text:CachedAlphaComparator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_text:CachedAlphaComparator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_text:CachedAlphaComparator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_text:AlphaComparator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_text:AlphaComparator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_text:AlphaComparator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___hash, /* pointer to native:CString:kernel#Object#hash */
...
(nitmethod_t)core___core__Object___output, /* pointer to native:CString:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to native:CString:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to native:CString:serialization#Object#is_same_serialized */
...
(nitmethod_t)core__abstract_text___CString___to_s_full, /* pointer to native:CString:abstract_text#CString#to_s_full */
...
(nitmethod_t)core___core__CString___fast_cstring, /* pointer to native:CString:native#CString#fast_cstring */
(nitmethod_t)core___core__CString___byte_to_char_index_cached, /* pointer to native:CString:native#CString#byte_to_char_index_cached */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to native:CString:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)VIRTUAL_json__serialization_write___core__CString___Serializable__accept_json_serializer, /* pointer to native:CString:serialization_write#CString#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to native:CString:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to native:CString:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to native:CString:serialization#Serializable#serialize_to */
(nitmethod_t)core__file___CString___file_delete, /* pointer to native:CString:file#CString#file_delete */
(nitmethod_t)core__file___CString___rmdir, /* pointer to native:CString:file#CString#rmdir */
(nitmethod_t)core__file___CString___file_lstat, /* pointer to native:CString:file#CString#file_lstat */
}
};
/* allocate CString */
...
(nitmethod_t)core___core__Object___output, /* pointer to kernel:Sys:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Sys:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Sys:serialization#Object#is_same_serialized */
...
(nitmethod_t)core__file___Sys___read_only, /* pointer to kernel:Sys:file#Sys#read_only */
(nitmethod_t)core__re___Sys___flag_extended, /* pointer to kernel:Sys:re#Sys#flag_extended */
(nitmethod_t)core__re___Sys___flag_icase, /* pointer to kernel:Sys:re#Sys#flag_icase */
(nitmethod_t)core__re___Sys___flag_nosub, /* pointer to kernel:Sys:re#Sys#flag_nosub */
(nitmethod_t)core__re___Sys___flag_newline, /* pointer to kernel:Sys:re#Sys#flag_newline */
(nitmethod_t)core__re___Sys___flag_notbol, /* pointer to kernel:Sys:re#Sys#flag_notbol */
(nitmethod_t)core__re___Sys___flag_noteol, /* pointer to kernel:Sys:re#Sys#flag_noteol */
...
(nitmethod_t)nitc__xcode_templates___core__Sys___pbx_uuid_generator, /* pointer to kernel:Sys:xcode_templates#Sys#pbx_uuid_generator */
(nitmethod_t)nitc__nitni_utilities___core__Sys___long_signature, /* pointer to kernel:Sys:nitni_utilities#Sys#long_signature */
(nitmethod_t)nitc__xcode_templates___core__Sys___pbx_file_types, /* pointer to kernel:Sys:xcode_templates#Sys#pbx_file_types */
...
(nitmethod_t)nitc__nitni_utilities___core__Sys___short_signature, /* pointer to kernel:Sys:nitni_utilities#Sys#short_signature */
(nitmethod_t)nitc__cpp___core__Sys___from_cpp_call_context, /* pointer to kernel:Sys:cpp#Sys#from_cpp_call_context */
(nitmethod_t)nitc__objc___core__Sys___from_objc_call_context, /* pointer to kernel:Sys:objc#Sys#from_objc_call_context */
(nitmethod_t)nitc__java___core__Sys___from_java_call_context, /* pointer to kernel:Sys:java#Sys#from_java_call_context */
(nitmethod_t)nitc__java___core__Sys___java_call_context, /* pointer to kernel:Sys:java#Sys#java_call_context */
(nitmethod_t)nitc__cpp___core__Sys___cpp_call_context, /* pointer to kernel:Sys:cpp#Sys#cpp_call_context */
(nitmethod_t)nitc__cpp___core__Sys___to_cpp_call_context, /* pointer to kernel:Sys:cpp#Sys#to_cpp_call_context */
(nitmethod_t)nitc__java___core__Sys___to_java_call_context, /* pointer to kernel:Sys:java#Sys#to_java_call_context */
...
(nitmethod_t)VIRTUAL_core___core__Bool___Object__output, /* pointer to kernel:Bool:kernel#Bool#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Bool:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Bool:serialization#Object#is_same_serialized */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to kernel:Bool:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)VIRTUAL_json__serialization_write___core__Bool___Serializable__accept_json_serializer, /* pointer to kernel:Bool:serialization_write#Bool#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to kernel:Bool:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to kernel:Bool:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to kernel:Bool:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)VIRTUAL_core___core__Float___Object__output, /* pointer to kernel:Float:kernel#Float#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Float:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Float:serialization#Object#is_same_serialized */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to kernel:Float:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)VIRTUAL_json__serialization_write___core__Float___Serializable__accept_json_serializer, /* pointer to kernel:Float:serialization_write#Float#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to kernel:Float:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to kernel:Float:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to kernel:Float:serialization#Serializable#serialize_to */
}
};
/* allocate Float */
...
(nitmethod_t)VIRTUAL_core___core__Byte___Object__output, /* pointer to kernel:Byte:kernel#Byte#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Byte:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Byte:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Byte___Discrete__predecessor, /* pointer to kernel:Byte:kernel#Byte#predecessor */
...
(nitmethod_t)VIRTUAL_core___core__Int___Object__output, /* pointer to kernel:Int:kernel#Int#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Int:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Int:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Int___Discrete__predecessor, /* pointer to kernel:Int:kernel#Int#predecessor */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to kernel:Int:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)VIRTUAL_json__serialization_write___core__Int___Serializable__accept_json_serializer, /* pointer to kernel:Int:serialization_write#Int#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to kernel:Int:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to kernel:Int:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to kernel:Int:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__re___Int___is_nomatch, /* pointer to kernel:Int:re#Int#is_nomatch */
...
(nitmethod_t)core__file___Int___fd_to_stream, /* pointer to kernel:Int:file#Int#fd_to_stream */
(nitmethod_t)core__range___Int___times, /* pointer to kernel:Int:range#Int#times */
}
};
...
(nitmethod_t)VIRTUAL_core___core__Char___Object__output, /* pointer to kernel:Char:kernel#Char#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Char:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Char:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Pattern___is_in, /* pointer to kernel:Char:string_search#Pattern#is_in */
(nitmethod_t)VIRTUAL_core___core__Char___Discrete__distance, /* pointer to kernel:Char:kernel#Char#distance */
(nitmethod_t)VIRTUAL_core___core__Char___Discrete__predecessor, /* pointer to kernel:Char:kernel#Char#predecessor */
...
(nitmethod_t)core__abstract_text___Char___escape_to_utf16, /* pointer to kernel:Char:abstract_text#Char#escape_to_utf16 */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to kernel:Char:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)VIRTUAL_json__serialization_write___core__Char___Serializable__accept_json_serializer, /* pointer to kernel:Char:serialization_write#Char#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to kernel:Char:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__DirectSerializable___Serializable__serialize_to_or_delay, /* pointer to kernel:Char:serialization#DirectSerializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to kernel:Char:serialization#Serializable#serialize_to */
...
(nitmethod_t)core___core__Object____61d_61d, /* pointer to kernel:Pointer:kernel#Object#== */
...
(nitmethod_t)core___core__Object___hash, /* pointer to kernel:Pointer:kernel#Object#hash */
...
(nitmethod_t)core___core__Object___output, /* pointer to kernel:Pointer:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to kernel:Pointer:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to kernel:Pointer:serialization#Object#is_same_serialized */
...
/* runtime class core__Range: core::Range (dead=false; need_corpse=false)*/
const struct class class_core__Range = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to range:Range:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to range:Range:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to range:Range:kernel#Object#sys */
(nitmethod_t)core___core__Range___core__kernel__Object___61d_61d, /* pointer to range:Range:range#Range#== */
(nitmethod_t)core__abstract_text___Collection___Object__to_s, /* pointer to range:Range:abstract_text#Collection#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to range:Range:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Range___core__kernel__Object__hash, /* pointer to range:Range:range#Range#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to range:Range:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to range:Range:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to range:Range:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to range:Range:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to range:Range:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to range:Range:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to range:Range:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to range:Range:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Range___without_last, /* pointer to range:Range:range#Range#without_last */
(nitmethod_t)core___core__Range___last, /* pointer to range:Range:range#Range#last */
(nitmethod_t)core___core__Range___after, /* pointer to range:Range:range#Range#after */
(nitmethod_t)core___core__Range___first_61d, /* pointer to range:Range:range#Range#first= */
(nitmethod_t)core___core__Range___last_61d, /* pointer to range:Range:range#Range#last= */
(nitmethod_t)core___core__Range___after_61d, /* pointer to range:Range:range#Range#after= */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core__abstract_text___Collection___join, /* pointer to range:Range:abstract_text#Collection#join */
(nitmethod_t)core__array___Collection___to_a, /* pointer to range:Range:array#Collection#to_a */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__length, /* pointer to range:Range:range#Range#length */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__is_empty, /* pointer to range:Range:range#Range#is_empty */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__iterator, /* pointer to range:Range:range#Range#iterator */
(nitmethod_t)core___core__Collection___has_exactly, /* pointer to range:Range:abstract_collection#Collection#has_exactly */
(nitmethod_t)core___core__Collection___has_all, /* pointer to range:Range:abstract_collection#Collection#has_all */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__has, /* pointer to range:Range:range#Range#has */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__count, /* pointer to range:Range:range#Range#count */
(nitmethod_t)core___core__Range___core__abstract_collection__Collection__first, /* pointer to range:Range:range#Range#first */
(nitmethod_t)core___core__Collection___not_empty, /* pointer to range:Range:abstract_collection#Collection#not_empty */
(nitmethod_t)core__abstract_text___Collection___plain_to_s, /* pointer to range:Range:abstract_text#Collection#plain_to_s */
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to range:Range:serialization_write#Collection#serialize_to_pure_json */
}
};
...
self = nit_alloc(sizeof(struct instance) + 3*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__Range;
return self;
}
/* runtime class core__range__IteratorRange: core::range::IteratorRange (dead=false; need_corpse=false)*/
const struct class class_core__range__IteratorRange = {
0, /* box_kind */
{
(nitmethod_t)core__range___core__range__IteratorRange___core__kernel__Object__init, /* pointer to range:IteratorRange:range#IteratorRange#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to range:IteratorRange:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to range:IteratorRange:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to range:IteratorRange:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to range:IteratorRange:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to range:IteratorRange:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to range:IteratorRange:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to range:IteratorRange:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to range:IteratorRange:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to range:IteratorRange:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to range:IteratorRange:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to range:IteratorRange:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to range:IteratorRange:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to range:IteratorRange:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to range:IteratorRange:serialization#Object#is_same_serialized */
(nitmethod_t)core__range___core__range__IteratorRange___core__abstract_collection__Iterator__is_ok, /* pointer to range:IteratorRange:range#IteratorRange#is_ok */
(nitmethod_t)core__range___core__range__IteratorRange___core__abstract_collection__Iterator__item, /* pointer to range:IteratorRange:range#IteratorRange#item */
(nitmethod_t)core__range___core__range__IteratorRange___core__abstract_collection__Iterator__next, /* pointer to range:IteratorRange:range#IteratorRange#next */
(nitmethod_t)core___core__Iterator___finish, /* pointer to range:IteratorRange:abstract_collection#Iterator#finish */
(nitmethod_t)core___core__Iterator___iterator, /* pointer to range:IteratorRange:abstract_collection#Iterator#iterator */
(nitmethod_t)core__array___Iterator___to_a, /* pointer to range:IteratorRange:array#Iterator#to_a */
(nitmethod_t)core__range___core__range__IteratorRange___range_61d, /* pointer to range:IteratorRange:range#IteratorRange#range= */
(nitmethod_t)core___core__Object___init, /* pointer to range:IteratorRange:kernel#Object#init */
}
};
...
self = nit_alloc(sizeof(struct instance) + 2*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__range__IteratorRange;
return self;
}
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:RefIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:RefIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:RefIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:Set:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:Set:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:Set:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to abstract_collection:Set:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to abstract_collection:Set:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to abstract_collection:Set:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to abstract_collection:Set:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to abstract_collection:Set:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to abstract_collection:Set:serialization#Serializable#serialize_to */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:MapKeysIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:MapKeysIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:MapKeysIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:MapValuesIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:MapValuesIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:MapValuesIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:CoupleMapIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:CoupleMapIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:CoupleMapIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to abstract_collection:Couple:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to abstract_collection:Couple:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to abstract_collection:Couple:serialization#Object#is_same_serialized */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to abstract_collection:Couple:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to abstract_collection:Couple:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)serialization___core__Couple___Serializable__core_serialize_to, /* pointer to abstract_collection:Couple:serialization#Couple#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to abstract_collection:Couple:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to abstract_collection:Couple:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to list:List:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to list:List:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to list:List:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to list:List:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to list:List:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to list:List:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to list:List:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to list:List:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to list:List:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to list:List:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core__collection___Sequence___subarray, /* pointer to list:List:collection#Sequence#subarray */
...
(nitmethod_t)core___core__Object___output, /* pointer to list:ListIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to list:ListIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to list:ListIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to list:ListReverseIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to list:ListReverseIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to list:ListReverseIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to list:ListNode:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to list:ListNode:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to list:ListNode:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to list:ListNode:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to list:ListNode:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to list:ListNode:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)serialization___core__Ref___Serializable__core_serialize_to, /* pointer to list:ListNode:serialization#Ref#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to list:ListNode:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to list:ListNode:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__AbstractArrayRead___core__kernel__Object__output, /* pointer to array:Array:array#AbstractArrayRead#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:Array:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:Array:serialization#Object#is_same_serialized */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to array:Array:serialization_write#Collection#serialize_to_pure_json */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to array:Array:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to array:Array:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to array:Array:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to array:Array:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to array:Array:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to array:Array:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core__collection___Sequence___subarray, /* pointer to array:Array:collection#Sequence#subarray */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArrayIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArrayIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArrayIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArrayReverseIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArrayReverseIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArrayReverseIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArraySet:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArraySet:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArraySet:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to array:ArraySet:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to array:ArraySet:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to array:ArraySet:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to array:ArraySet:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to array:ArraySet:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to array:ArraySet:serialization#Serializable#serialize_to */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArraySetIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArraySetIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArraySetIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArrayMap:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArrayMap:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArrayMap:serialization#Object#is_same_serialized */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to array:ArrayMap:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Map___Serializable__accept_json_serializer, /* pointer to array:ArrayMap:serialization_write#Map#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to array:ArrayMap:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to array:ArrayMap:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to array:ArrayMap:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArrayMapKeys:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArrayMapKeys:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArrayMapKeys:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to array:ArrayMapKeys:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:ArrayMapValues:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:ArrayMapValues:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:ArrayMapValues:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to array:ArrayMapValues:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to array:NativeArray:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to array:NativeArray:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to array:NativeArray:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to circular_array:CircularArray:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to circular_array:CircularArray:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to circular_array:CircularArray:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to circular_array:CircularArray:serialization_write#Collection#serialize_to_pure_json */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to circular_array:CircularArray:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to circular_array:CircularArray:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to circular_array:CircularArray:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to circular_array:CircularArray:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to circular_array:CircularArray:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to circular_array:CircularArray:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core__collection___Sequence___subarray, /* pointer to circular_array:CircularArray:collection#Sequence#subarray */
...
(nitmethod_t)core___core__Object___output, /* pointer to circular_array:CircularArrayIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to circular_array:CircularArrayIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to circular_array:CircularArrayIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to sorter:DefaultComparator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to sorter:DefaultComparator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to sorter:DefaultComparator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashMap:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashMap:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashMap:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to hash_collection:HashMap:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Map___Serializable__accept_json_serializer, /* pointer to hash_collection:HashMap:serialization_write#Map#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to hash_collection:HashMap:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to hash_collection:HashMap:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to hash_collection:HashMap:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashMapKeys:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashMapKeys:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashMapKeys:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to hash_collection:HashMapKeys:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashMapValues:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashMapValues:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashMapValues:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to hash_collection:HashMapValues:serialization_write#Collection#serialize_to_pure_json */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashMapNode:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashMapNode:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashMapNode:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashMapIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashMapIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashMapIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashSet:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashSet:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashSet:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to hash_collection:HashSet:serialization_write#Collection#serialize_to_pure_json */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to hash_collection:HashSet:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to hash_collection:HashSet:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to hash_collection:HashSet:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to hash_collection:HashSet:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to hash_collection:HashSet:serialization#Serializable#serialize_to */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashSetNode:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashSetNode:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashSetNode:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to hash_collection:HashSetIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to hash_collection:HashSetIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to hash_collection:HashSetIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Int8___core__kernel__Object__output, /* pointer to fixed_ints:Int8:fixed_ints#Int8#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to fixed_ints:Int8:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to fixed_ints:Int8:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Int8___core__kernel__Discrete__predecessor, /* pointer to fixed_ints:Int8:fixed_ints#Int8#predecessor */
...
(nitmethod_t)VIRTUAL_core___core__Int16___core__kernel__Object__output, /* pointer to fixed_ints:Int16:fixed_ints#Int16#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to fixed_ints:Int16:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to fixed_ints:Int16:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Int16___core__kernel__Discrete__predecessor, /* pointer to fixed_ints:Int16:fixed_ints#Int16#predecessor */
...
(nitmethod_t)VIRTUAL_core___core__UInt16___core__kernel__Object__output, /* pointer to fixed_ints:UInt16:fixed_ints#UInt16#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to fixed_ints:UInt16:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to fixed_ints:UInt16:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__UInt16___core__kernel__Discrete__predecessor, /* pointer to fixed_ints:UInt16:fixed_ints#UInt16#predecessor */
...
(nitmethod_t)VIRTUAL_core___core__Int32___core__kernel__Object__output, /* pointer to fixed_ints:Int32:fixed_ints#Int32#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to fixed_ints:Int32:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to fixed_ints:Int32:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__Int32___core__kernel__Discrete__predecessor, /* pointer to fixed_ints:Int32:fixed_ints#Int32#predecessor */
...
(nitmethod_t)VIRTUAL_core___core__UInt32___core__kernel__Object__output, /* pointer to fixed_ints:UInt32:fixed_ints#UInt32#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to fixed_ints:UInt32:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to fixed_ints:UInt32:serialization#Object#is_same_serialized */
...
(nitmethod_t)VIRTUAL_core___core__UInt32___core__kernel__Discrete__predecessor, /* pointer to fixed_ints:UInt32:fixed_ints#UInt32#predecessor */
...
(nitmethod_t)core___core__Object___output, /* pointer to string_search:Match:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to string_search:Match:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to string_search:Match:serialization#Object#is_same_serialized */
...
(nitmethod_t)core__re___Match___subs, /* pointer to string_search:Match:re#Match#subs */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:FileReader:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:FileReader:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:FileReader:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__FileReader___from_fd, /* pointer to file:FileReader:file#FileReader#from_fd */
...
(nitmethod_t)core___core__BufferedReader___Reader__read_byte, /* pointer to file:FileReader:stream#BufferedReader#read_byte */
...
(nitmethod_t)core___core__BufferedReader___Reader__read_char, /* pointer to file:FileReader:stream#BufferedReader#read_char */
...
self->attrs[COLOR_core__stream__BufferedReader___buffer].str = var3; /* _buffer on <self:FileReader exact> */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:FileWriter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:FileWriter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:FileWriter:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:Stdin:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:Stdin:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:Stdin:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__FileReader___from_fd, /* pointer to file:Stdin:file#FileReader#from_fd */
...
(nitmethod_t)core___core__BufferedReader___Reader__read_byte, /* pointer to file:Stdin:stream#BufferedReader#read_byte */
...
(nitmethod_t)core___core__BufferedReader___Reader__read_char, /* pointer to file:Stdin:stream#BufferedReader#read_char */
...
self->attrs[COLOR_core__stream__BufferedReader___buffer].str = var3; /* _buffer on <self:Stdin exact> */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:Stdout:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:Stdout:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:Stdout:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:Stderr:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:Stderr:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:Stderr:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:Path:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:Path:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:Path:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Path___exists, /* pointer to file:Path:file#Path#exists */
(nitmethod_t)core___core__Path___delete, /* pointer to file:Path:file#Path#delete */
(nitmethod_t)core___core__Path___rmdir, /* pointer to file:Path:file#Path#rmdir */
(nitmethod_t)core___core__Path___last_error, /* pointer to file:Path:file#Path#last_error */
(nitmethod_t)core___core__Path___copy, /* pointer to file:Path:file#Path#copy */
(nitmethod_t)core___core__Path___stat, /* pointer to file:Path:file#Path#stat */
(nitmethod_t)core___core__Path___files, /* pointer to file:Path:file#Path#files */
(nitmethod_t)core___core__Path___link_stat, /* pointer to file:Path:file#Path#link_stat */
(nitmethod_t)core___core__Path___open_ro, /* pointer to file:Path:file#Path#open_ro */
(nitmethod_t)core___core__Path____47d, /* pointer to file:Path:file#Path#/ */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:FileStat:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:FileStat:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:FileStat:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object____61d_61d, /* pointer to file:NativeFileStat:kernel#Object#== */
...
(nitmethod_t)core___core__Object___hash, /* pointer to file:NativeFileStat:kernel#Object#hash */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:NativeFileStat:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:NativeFileStat:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:NativeFileStat:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object____61d_61d, /* pointer to file:NativeFile:kernel#Object#== */
...
(nitmethod_t)core___core__Object___hash, /* pointer to file:NativeFile:kernel#Object#hash */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:NativeFile:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:NativeFile:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:NativeFile:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object____61d_61d, /* pointer to file:NativeDir:kernel#Object#== */
...
(nitmethod_t)core___core__Object___hash, /* pointer to file:NativeDir:kernel#Object#hash */
...
(nitmethod_t)core___core__Object___output, /* pointer to file:NativeDir:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to file:NativeDir:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to file:NativeDir:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to stream:IOError:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to stream:IOError:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to stream:IOError:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Error___cause, /* pointer to stream:IOError:error#Error#cause */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to stream:IOError:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to stream:IOError:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)serialization___core__Error___Serializable__core_serialize_to, /* pointer to stream:IOError:serialization#Error#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to stream:IOError:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to stream:IOError:serialization#Serializable#serialize_to */
}
};
/* allocate IOError */
...
/* runtime class core__StringWriter: core::StringWriter (dead=false; need_corpse=false)*/
const struct class class_core__StringWriter = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to stream:StringWriter:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to stream:StringWriter:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to stream:StringWriter:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to stream:StringWriter:kernel#Object#== */
(nitmethod_t)core___core__StringWriter___core__abstract_text__Object__to_s, /* pointer to stream:StringWriter:stream#StringWriter#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to stream:StringWriter:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to stream:StringWriter:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to stream:StringWriter:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to stream:StringWriter:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to stream:StringWriter:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to stream:StringWriter:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to stream:StringWriter:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to stream:StringWriter:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to stream:StringWriter:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to stream:StringWriter:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Stream___last_error_61d, /* pointer to stream:StringWriter:stream#Stream#last_error= */
(nitmethod_t)core___core__Stream___last_error, /* pointer to stream:StringWriter:stream#Stream#last_error */
(nitmethod_t)core___core__StringWriter___Stream__close, /* pointer to stream:StringWriter:stream#StringWriter#close */
(nitmethod_t)core___core__StringWriter___content, /* pointer to stream:StringWriter:stream#StringWriter#content */
(nitmethod_t)core___core__StringWriter___closed, /* pointer to stream:StringWriter:stream#StringWriter#closed */
(nitmethod_t)core___core__StringWriter___closed_61d, /* pointer to stream:StringWriter:stream#StringWriter#closed= */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core___core__StringWriter___Writer__write, /* pointer to stream:StringWriter:stream#StringWriter#write */
(nitmethod_t)core___core__StringWriter___Writer__write_bytes, /* pointer to stream:StringWriter:stream#StringWriter#write_bytes */
(nitmethod_t)core___core__Writer___write_char, /* pointer to stream:StringWriter:stream#Writer#write_char */
}
};
/* allocate StringWriter */
val* NEW_core__StringWriter(const struct type* type) {
val* self /* : StringWriter */;
val* var /* : Sys */;
val* var1 /* : Codec */;
val* var2 /* : Array[String] */;
self = nit_alloc(sizeof(struct instance) + 5*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__StringWriter;
var = glob_sys;
{
var1 = core__utf8___Sys___utf8_codec(var);
}
self->attrs[COLOR_core__stream__Writer___coder].val = var1; /* _coder on <self:StringWriter exact> */
var2 = NEW_core__Array(&type_core__Array__core__String);
{
core___core__Array___core__kernel__Object__init(var2); /* Direct call array#Array#init on <var2:Array[String]>*/
}
self->attrs[COLOR_core__stream__StringWriter___content].val = var2; /* _content on <self:StringWriter exact> */
self->attrs[COLOR_core__stream__StringWriter___closed].s = 0; /* _closed on <self:StringWriter exact> */
return self;
}
...
/* runtime class core__Error: core::Error (dead=false; need_corpse=false)*/
const struct class class_core__Error = {
0, /* box_kind */
{
(nitmethod_t)core___core__Error___core__kernel__Object__init, /* pointer to error:Error:error#Error#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to error:Error:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to error:Error:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to error:Error:kernel#Object#== */
(nitmethod_t)core___core__Error___core__abstract_text__Object__to_s, /* pointer to error:Error:error#Error#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to error:Error:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to error:Error:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to error:Error:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to error:Error:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to error:Error:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to error:Error:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to error:Error:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to error:Error:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to error:Error:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to error:Error:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Error___message_61d, /* pointer to error:Error:error#Error#message= */
(nitmethod_t)core___core__Error___message, /* pointer to error:Error:error#Error#message */
(nitmethod_t)core___core__Error___cause, /* pointer to error:Error:error#Error#cause */
(nitmethod_t)core___core__Object___init, /* pointer to error:Error:kernel#Object#init */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to error:Error:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to error:Error:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)serialization___core__Error___Serializable__core_serialize_to, /* pointer to error:Error:serialization#Error#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to error:Error:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to error:Error:serialization#Serializable#serialize_to */
}
};
/* allocate Error */
...
(nitmethod_t)core___core__AbstractArrayRead___core__kernel__Object__output, /* pointer to bytes:Bytes:array#AbstractArrayRead#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to bytes:Bytes:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to bytes:Bytes:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to bytes:Bytes:serialization_write#Collection#serialize_to_pure_json */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to bytes:Bytes:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__SimpleCollection___Serializable__accept_json_serializer, /* pointer to bytes:Bytes:serialization_write#SimpleCollection#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to bytes:Bytes:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to bytes:Bytes:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to bytes:Bytes:serialization#Serializable#serialize_to */
...
(nitmethod_t)core__collection___SequenceRead___levenshtein_distance, /* pointer to bytes:Bytes:collection#SequenceRead#levenshtein_distance */
...
(nitmethod_t)core__collection___Sequence___subarray, /* pointer to bytes:Bytes:collection#Sequence#subarray */
...
(nitmethod_t)core___core__Object___output, /* pointer to bytes:BytesIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to bytes:BytesIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to bytes:BytesIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to utf8:UTF8Codec:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to utf8:UTF8Codec:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to utf8:UTF8Codec:serialization#Object#is_same_serialized */
}
};
/* allocate UTF8Codec */
...
/* runtime class core__Tm: core::Tm (dead=false; need_corpse=true)*/
const struct class class_core__Tm = {
7, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to time:Tm:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to time:Tm:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to time:Tm:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to time:Tm:kernel#Object#== */
(nitmethod_t)core___core__Tm___core__abstract_text__Object__to_s, /* pointer to time:Tm:time#Tm#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to time:Tm:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to time:Tm:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to time:Tm:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to time:Tm:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to time:Tm:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to time:Tm:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to time:Tm:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to time:Tm:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to time:Tm:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to time:Tm:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Pointer___address_is_null, /* pointer to time:Tm:kernel#Pointer#address_is_null */
(nitmethod_t)core___core__Pointer___free, /* pointer to time:Tm:kernel#Pointer#free */
(nitmethod_t)core___core__Tm___localtime, /* pointer to time:Tm:time#Tm#localtime */
(nitmethod_t)core___core__Tm___strftime, /* pointer to time:Tm:time#Tm#strftime */
(nitmethod_t)core___core__Tm___asctime, /* pointer to time:Tm:time#Tm#asctime */
}
};
/* allocate extern Tm */
...
/* runtime class core__Process: core::Process (dead=false; need_corpse=false)*/
const struct class class_core__Process = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to exec:Process:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to exec:Process:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to exec:Process:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to exec:Process:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to exec:Process:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to exec:Process:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to exec:Process:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to exec:Process:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to exec:Process:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to exec:Process:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to exec:Process:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to exec:Process:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to exec:Process:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to exec:Process:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to exec:Process:serialization#Object#is_same_serialized */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core___core__Process___init, /* pointer to exec:Process:exec#Process#init */
(nitmethod_t)core___core__Process___wait, /* pointer to exec:Process:exec#Process#wait */
(nitmethod_t)core___core__Process___status, /* pointer to exec:Process:exec#Process#status */
(nitmethod_t)core___core__Process___from_a, /* pointer to exec:Process:exec#Process#from_a */
(nitmethod_t)core___core__Process___command_61d, /* pointer to exec:Process:exec#Process#command= */
(nitmethod_t)core___core__Process___arguments_61d, /* pointer to exec:Process:exec#Process#arguments= */
(nitmethod_t)core___core__Process___execute, /* pointer to exec:Process:exec#Process#execute */
(nitmethod_t)core___core__Process___data, /* pointer to exec:Process:exec#Process#data */
(nitmethod_t)core___core__Process___is_finished, /* pointer to exec:Process:exec#Process#is_finished */
(nitmethod_t)core___core__Process___command, /* pointer to exec:Process:exec#Process#command */
(nitmethod_t)core___core__Process___arguments, /* pointer to exec:Process:exec#Process#arguments */
(nitmethod_t)core___core__Process___data_61d, /* pointer to exec:Process:exec#Process#data= */
(nitmethod_t)core___core__Process___basic_exec_execute, /* pointer to exec:Process:exec#Process#basic_exec_execute */
(nitmethod_t)core___core__Process___pipeflags, /* pointer to exec:Process:exec#Process#pipeflags */
}
};
/* allocate Process */
...
self = nit_alloc(sizeof(struct instance) + 4*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__Process;
return self;
}
/* runtime class core__ProcessReader: core::ProcessReader (dead=false; need_corpse=false)*/
const struct class class_core__ProcessReader = {
0, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to exec:ProcessReader:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to exec:ProcessReader:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to exec:ProcessReader:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to exec:ProcessReader:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to exec:ProcessReader:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to exec:ProcessReader:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to exec:ProcessReader:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to exec:ProcessReader:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to exec:ProcessReader:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to exec:ProcessReader:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to exec:ProcessReader:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to exec:ProcessReader:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to exec:ProcessReader:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to exec:ProcessReader:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to exec:ProcessReader:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Stream___last_error_61d, /* pointer to exec:ProcessReader:stream#Stream#last_error= */
(nitmethod_t)core___core__Stream___last_error, /* pointer to exec:ProcessReader:stream#Stream#last_error */
(nitmethod_t)core___core__ProcessReader___core__stream__Stream__close, /* pointer to exec:ProcessReader:exec#ProcessReader#close */
(nitmethod_t)core___core__Process___init, /* pointer to exec:ProcessReader:exec#Process#init */
(nitmethod_t)core___core__Process___wait, /* pointer to exec:ProcessReader:exec#Process#wait */
(nitmethod_t)core___core__Process___status, /* pointer to exec:ProcessReader:exec#Process#status */
(nitmethod_t)core___core__Process___from_a, /* pointer to exec:ProcessReader:exec#Process#from_a */
(nitmethod_t)core___core__Process___command_61d, /* pointer to exec:ProcessReader:exec#Process#command= */
(nitmethod_t)core___core__Process___arguments_61d, /* pointer to exec:ProcessReader:exec#Process#arguments= */
(nitmethod_t)core___core__ProcessReader___Process__execute, /* pointer to exec:ProcessReader:exec#ProcessReader#execute */
(nitmethod_t)core___core__Process___data, /* pointer to exec:ProcessReader:exec#Process#data */
(nitmethod_t)core___core__Process___is_finished, /* pointer to exec:ProcessReader:exec#Process#is_finished */
(nitmethod_t)core___core__Process___command, /* pointer to exec:ProcessReader:exec#Process#command */
(nitmethod_t)core___core__Process___arguments, /* pointer to exec:ProcessReader:exec#Process#arguments */
(nitmethod_t)core___core__Process___data_61d, /* pointer to exec:ProcessReader:exec#Process#data= */
(nitmethod_t)core___core__Process___basic_exec_execute, /* pointer to exec:ProcessReader:exec#Process#basic_exec_execute */
(nitmethod_t)core___core__ProcessReader___Process__pipeflags, /* pointer to exec:ProcessReader:exec#ProcessReader#pipeflags */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)core___core__Reader___read_all, /* pointer to exec:ProcessReader:stream#Reader#read_all */
(nitmethod_t)core___core__Reader___read_all_bytes, /* pointer to exec:ProcessReader:stream#Reader#read_all_bytes */
(nitmethod_t)core___core__ProcessReader___core__stream__Reader__eof, /* pointer to exec:ProcessReader:exec#ProcessReader#eof */
(nitmethod_t)core___core__Reader___read_line, /* pointer to exec:ProcessReader:stream#Reader#read_line */
(nitmethod_t)core___core__ProcessReader___core__stream__Reader__read_byte, /* pointer to exec:ProcessReader:exec#ProcessReader#read_byte */
(nitmethod_t)core___core__Reader___append_line_to, /* pointer to exec:ProcessReader:stream#Reader#append_line_to */
(nitmethod_t)core___core__ProcessReader___core__stream__Reader__read_char, /* pointer to exec:ProcessReader:exec#ProcessReader#read_char */
(nitmethod_t)core___core__Reader___read_bytes, /* pointer to exec:ProcessReader:stream#Reader#read_bytes */
(nitmethod_t)core___core__ProcessReader___stream_in, /* pointer to exec:ProcessReader:exec#ProcessReader#stream_in */
(nitmethod_t)core___core__ProcessReader___stream_in_61d, /* pointer to exec:ProcessReader:exec#ProcessReader#stream_in= */
(nitmethod_t)core___core__Process___execute, /* pointer to exec:ProcessReader:exec#Process#execute */
}
};
/* allocate ProcessReader */
val* NEW_core__ProcessReader(const struct type* type) {
val* self /* : ProcessReader */;
val* var /* : Sys */;
val* var1 /* : Codec */;
self = nit_alloc(sizeof(struct instance) + 7*sizeof(nitattribute_t));
self->type = type;
self->class = &class_core__ProcessReader;
var = glob_sys;
{
var1 = core__utf8___Sys___utf8_codec(var);
}
self->attrs[COLOR_core__stream__Reader___decoder].val = var1; /* _decoder on <self:ProcessReader exact> */
return self;
}
...
/* runtime class core__exec__NativeProcess: core::exec::NativeProcess (dead=false; need_corpse=true)*/
const struct class class_core__exec__NativeProcess = {
7, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to exec:NativeProcess:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to exec:NativeProcess:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to exec:NativeProcess:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to exec:NativeProcess:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to exec:NativeProcess:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to exec:NativeProcess:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to exec:NativeProcess:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to exec:NativeProcess:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to exec:NativeProcess:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to exec:NativeProcess:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to exec:NativeProcess:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to exec:NativeProcess:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to exec:NativeProcess:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to exec:NativeProcess:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to exec:NativeProcess:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Pointer___address_is_null, /* pointer to exec:NativeProcess:kernel#Pointer#address_is_null */
(nitmethod_t)core___core__Pointer___free, /* pointer to exec:NativeProcess:kernel#Pointer#free */
(nitmethod_t)core__exec___core__exec__NativeProcess___wait, /* pointer to exec:NativeProcess:exec#NativeProcess#wait */
(nitmethod_t)core__exec___core__exec__NativeProcess___status, /* pointer to exec:NativeProcess:exec#NativeProcess#status */
(nitmethod_t)core__exec___core__exec__NativeProcess___out_fd, /* pointer to exec:NativeProcess:exec#NativeProcess#out_fd */
(nitmethod_t)core__exec___core__exec__NativeProcess___is_finished, /* pointer to exec:NativeProcess:exec#NativeProcess#is_finished */
}
};
/* allocate extern NativeProcess */
val* NEW_core__exec__NativeProcess(const struct type* type) {
val* self /* : NativeProcess */;
self = nit_alloc(sizeof(struct instance_core__Pointer));
self->type = type;
self->class = &class_core__exec__NativeProcess;
((struct instance_core__Pointer*)self)->value = NULL;
return self;
}
...
/* runtime class core__re__NativeRegex: core::re::NativeRegex (dead=false; need_corpse=true)*/
const struct class class_core__re__NativeRegex = {
7, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to re:NativeRegex:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to re:NativeRegex:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to re:NativeRegex:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to re:NativeRegex:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to re:NativeRegex:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to re:NativeRegex:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to re:NativeRegex:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to re:NativeRegex:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to re:NativeRegex:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to re:NativeRegex:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to re:NativeRegex:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to re:NativeRegex:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to re:NativeRegex:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to re:NativeRegex:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to re:NativeRegex:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Pointer___address_is_null, /* pointer to re:NativeRegex:kernel#Pointer#address_is_null */
(nitmethod_t)core___core__Pointer___free, /* pointer to re:NativeRegex:kernel#Pointer#free */
(nitmethod_t)core__re___core__re__NativeRegex___re_nsub, /* pointer to re:NativeRegex:re#NativeRegex#re_nsub */
(nitmethod_t)core__re___core__re__NativeRegex___regfree, /* pointer to re:NativeRegex:re#NativeRegex#regfree */
(nitmethod_t)core__re___core__re__NativeRegex___regexec, /* pointer to re:NativeRegex:re#NativeRegex#regexec */
(nitmethod_t)core__re___core__re__NativeRegex___malloc, /* pointer to re:NativeRegex:re#NativeRegex#malloc */
(nitmethod_t)core__re___core__re__NativeRegex___regcomp, /* pointer to re:NativeRegex:re#NativeRegex#regcomp */
(nitmethod_t)core__re___core__re__NativeRegex___regerror, /* pointer to re:NativeRegex:re#NativeRegex#regerror */
(nitmethod_t)core__re___core__re__NativeRegex___regexec_match_only, /* pointer to re:NativeRegex:re#NativeRegex#regexec_match_only */
}
};
/* allocate extern NativeRegex */
val* NEW_core__re__NativeRegex(const struct type* type) {
val* self /* : NativeRegex */;
self = nit_alloc(sizeof(struct instance_core__Pointer));
self->type = type;
self->class = &class_core__re__NativeRegex;
((struct instance_core__Pointer*)self)->value = NULL;
return self;
}
/* runtime class core__re__NativeMatchArray: core::re::NativeMatchArray (dead=false; need_corpse=true)*/
const struct class class_core__re__NativeMatchArray = {
7, /* box_kind */
{
(nitmethod_t)core___core__Object___init, /* pointer to re:NativeMatchArray:kernel#Object#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to re:NativeMatchArray:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to re:NativeMatchArray:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to re:NativeMatchArray:kernel#Object#== */
(nitmethod_t)core__abstract_text___Object___to_s, /* pointer to re:NativeMatchArray:abstract_text#Object#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to re:NativeMatchArray:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to re:NativeMatchArray:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to re:NativeMatchArray:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to re:NativeMatchArray:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to re:NativeMatchArray:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to re:NativeMatchArray:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to re:NativeMatchArray:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to re:NativeMatchArray:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to re:NativeMatchArray:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to re:NativeMatchArray:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Pointer___address_is_null, /* pointer to re:NativeMatchArray:kernel#Pointer#address_is_null */
(nitmethod_t)core___core__Pointer___free, /* pointer to re:NativeMatchArray:kernel#Pointer#free */
(nitmethod_t)core__re___core__re__NativeMatchArray___malloc, /* pointer to re:NativeMatchArray:re#NativeMatchArray#malloc */
(nitmethod_t)core__re___core__re__NativeMatchArray___rm_so, /* pointer to re:NativeMatchArray:re#NativeMatchArray#rm_so */
(nitmethod_t)core__re___core__re__NativeMatchArray___rm_eo, /* pointer to re:NativeMatchArray:re#NativeMatchArray#rm_eo */
(nitmethod_t)core__re___core__re__NativeMatchArray____91d_93d, /* pointer to re:NativeMatchArray:re#NativeMatchArray#[] */
}
};
/* allocate extern NativeMatchArray */
val* NEW_core__re__NativeMatchArray(const struct type* type) {
val* self /* : NativeMatchArray */;
self = nit_alloc(sizeof(struct instance_core__Pointer));
self->type = type;
self->class = &class_core__re__NativeMatchArray;
((struct instance_core__Pointer*)self)->value = NULL;
return self;
}
/* runtime class core__Regex: core::Regex (dead=false; need_corpse=false)*/
const struct class class_core__Regex = {
0, /* box_kind */
{
(nitmethod_t)core___core__Regex___core__kernel__Object__init, /* pointer to re:Regex:re#Regex#init */
(nitmethod_t)core___core__Object____33d_61d, /* pointer to re:Regex:kernel#Object#!= */
(nitmethod_t)core___core__Object___sys, /* pointer to re:Regex:kernel#Object#sys */
(nitmethod_t)core___core__Object____61d_61d, /* pointer to re:Regex:kernel#Object#== */
(nitmethod_t)core___core__Regex___core__abstract_text__Object__to_s, /* pointer to re:Regex:re#Regex#to_s */
(nitmethod_t)core___core__Object___is_same_instance, /* pointer to re:Regex:kernel#Object#is_same_instance */
(nitmethod_t)core___core__Object___hash, /* pointer to re:Regex:kernel#Object#hash */
(nitmethod_t)core__abstract_text___Object___inspect, /* pointer to re:Regex:abstract_text#Object#inspect */
(nitmethod_t)core___core__Object___object_id, /* pointer to re:Regex:kernel#Object#object_id */
(nitmethod_t)core__abstract_text___Object___class_name, /* pointer to re:Regex:abstract_text#Object#class_name */
(nitmethod_t)core__abstract_text___Object___inspect_head, /* pointer to re:Regex:abstract_text#Object#inspect_head */
(nitmethod_t)core__abstract_text___Object___native_class_name, /* pointer to re:Regex:abstract_text#Object#native_class_name */
(nitmethod_t)core___core__Object___output, /* pointer to re:Regex:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to re:Regex:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to re:Regex:serialization#Object#is_same_serialized */
(nitmethod_t)core___core__Regex___core__gc__Finalizable__finalize, /* pointer to re:Regex:re#Regex#finalize */
(nitmethod_t)core___core__Regex___native_match_is_init_61d, /* pointer to re:Regex:re#Regex#native_match_is_init= */
(nitmethod_t)core___core__Regex___native, /* pointer to re:Regex:re#Regex#native */
(nitmethod_t)core___core__Regex___string_61d, /* pointer to re:Regex:re#Regex#string= */
(nitmethod_t)core___core__Regex___native_61d, /* pointer to re:Regex:re#Regex#native= */
(nitmethod_t)core___core__Regex___native_match_is_init, /* pointer to re:Regex:re#Regex#native_match_is_init */
(nitmethod_t)core___core__Regex___native_match, /* pointer to re:Regex:re#Regex#native_match */
(nitmethod_t)core___core__Regex___string, /* pointer to re:Regex:re#Regex#string */
(nitmethod_t)core___core__Pattern___split_in, /* pointer to re:Regex:string_search#Pattern#split_in */
(nitmethod_t)core___core__Regex___core__string_search__Pattern__search_in, /* pointer to re:Regex:re#Regex#search_in */
(nitmethod_t)core___core__Regex___core__string_search__Pattern__search_index_in, /* pointer to re:Regex:re#Regex#search_index_in */
(nitmethod_t)core___core__Regex___core__string_search__Pattern__is_in, /* pointer to re:Regex:re#Regex#is_in */
(nitmethod_t)core___core__Regex___optimize_has, /* pointer to re:Regex:re#Regex#optimize_has */
(nitmethod_t)core___core__Regex___compile, /* pointer to re:Regex:re#Regex#compile */
(nitmethod_t)core___core__Regex___gather_eflags, /* pointer to re:Regex:re#Regex#gather_eflags */
(nitmethod_t)core___core__Regex___get_error, /* pointer to re:Regex:re#Regex#get_error */
(nitmethod_t)core___core__Regex___extended, /* pointer to re:Regex:re#Regex#extended */
(nitmethod_t)core___core__Regex___ignore_case, /* pointer to re:Regex:re#Regex#ignore_case */
(nitmethod_t)core___core__Regex___newline, /* pointer to re:Regex:re#Regex#newline */
(nitmethod_t)core___core__Regex___cflags_cache, /* pointer to re:Regex:re#Regex#cflags_cache */
(nitmethod_t)core___core__Regex___string_cache, /* pointer to re:Regex:re#Regex#string_cache */
(nitmethod_t)core___core__Regex___cflags_cache_61d, /* pointer to re:Regex:re#Regex#cflags_cache= */
(nitmethod_t)core___core__Regex___string_cache_61d, /* pointer to re:Regex:re#Regex#string_cache= */
(nitmethod_t)core___core__Regex___not_bol, /* pointer to re:Regex:re#Regex#not_bol */
(nitmethod_t)core___core__Regex___not_eol, /* pointer to re:Regex:re#Regex#not_eol */
(nitmethod_t)core___core__Object___init, /* pointer to re:Regex:kernel#Object#init */
}
};
/* allocate Regex */
...
self->type = type;
self->class = &class_core__Regex;
self->attrs[COLOR_core__re__Regex___extended].s = 1; /* _extended on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___ignore_case].s = 0; /* _ignore_case on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___optimize_has].s = 0; /* _optimize_has on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___newline].s = 0; /* _newline on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___not_bol].s = 0; /* _not_bol on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___not_eol].s = 0; /* _not_eol on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___native_match_is_init].s = 0; /* _native_match_is_init on <self:Regex exact> */
self->attrs[COLOR_core__re__Regex___cflags_cache].l = 0l; /* _cflags_cache on <self:Regex exact> */
gc_register_finalizer(self);
return self;
}
...
(nitmethod_t)core___core__Object___output, /* pointer to more_collections:MultiHashMap:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to more_collections:MultiHashMap:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to more_collections:MultiHashMap:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to more_collections:MultiHashMap:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___core__Map___Serializable__accept_json_serializer, /* pointer to more_collections:MultiHashMap:serialization_write#Map#accept_json_serializer */
(nitmethod_t)serialization___serialization__Serializable___core_serialize_to, /* pointer to more_collections:MultiHashMap:serialization#Serializable#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to more_collections:MultiHashMap:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to more_collections:MultiHashMap:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to more_collections:HashMap2:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to more_collections:HashMap2:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to more_collections:HashMap2:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to more_collections:HashMap3:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to more_collections:HashMap3:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to more_collections:HashMap3:serialization#Object#is_same_serialized */
...
/* runtime class more_collections__UnrolledNode: more_collections::UnrolledNode (dead=true; need_corpse=false)*/
...
/* runtime class more_collections__UnrolledIterator: more_collections::UnrolledIterator (dead=true; need_corpse=false)*/
...
(nitmethod_t)core___core__Object___output, /* pointer to more_collections:BestDistance:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to more_collections:BestDistance:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to more_collections:BestDistance:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to poset:POSet:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to poset:POSet:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to poset:POSet:serialization#Object#is_same_serialized */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to poset:POSet:serialization_write#Collection#serialize_to_pure_json */
...
(nitmethod_t)nitc__serialize_model___poset__POSet___to_thin_json, /* pointer to poset:POSet:serialize_model#POSet#to_thin_json */
(nitmethod_t)nitc__coloring___poset__POSet___to_conflict_graph, /* pointer to poset:POSet:coloring#POSet#to_conflict_graph */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to poset:POSet:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to poset:POSet:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)poset___poset__POSet___serialization__Serializable__core_serialize_to, /* pointer to poset:POSet:poset#POSet#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to poset:POSet:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to poset:POSet:serialization#Serializable#serialize_to */
(nitmethod_t)poset___poset__POSet___select_smallest, /* pointer to poset:POSet:poset#POSet#select_smallest */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to poset:POSetElement:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to poset:POSetElement:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to poset:POSetElement:serialization#Object#is_same_serialized */
...
NULL, /* empty */
NULL, /* empty */
(nitmethod_t)json__serialization_write___serialization__Serializable___serialize_to_json, /* pointer to poset:POSetElement:serialization_write#Serializable#serialize_to_json */
(nitmethod_t)json__serialization_write___serialization__Serializable___accept_json_serializer, /* pointer to poset:POSetElement:serialization_write#Serializable#accept_json_serializer */
(nitmethod_t)poset___poset__POSetElement___serialization__Serializable__core_serialize_to, /* pointer to poset:POSetElement:poset#POSetElement#core_serialize_to */
(nitmethod_t)serialization___serialization__Serializable___serialize_to_or_delay, /* pointer to poset:POSetElement:serialization#Serializable#serialize_to_or_delay */
(nitmethod_t)serialization___serialization__Serializable___serialize_to, /* pointer to poset:POSetElement:serialization#Serializable#serialize_to */
}
};
...
(nitmethod_t)core___core__Object___output, /* pointer to mdoc:MDoc:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to mdoc:MDoc:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to mdoc:MDoc:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to mdoc:MDeprecationInfo:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to mdoc:MDeprecationInfo:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to mdoc:MDeprecationInfo:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to ordered_tree:OrderedTree:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ordered_tree:OrderedTree:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ordered_tree:OrderedTree:serialization#Object#is_same_serialized */
NULL, /* empty */
NULL, /* empty */
NULL, /* empty */
...
(nitmethod_t)json__serialization_write___core__Collection___serialize_to_pure_json, /* pointer to ordered_tree:OrderedTree:serialization_write#Collection#serialize_to_pure_json */
...
/* runtime class ordered_tree__OrderedTreeIterator: ordered_tree::OrderedTreeIterator (dead=false; need_corpse=false)*/
...
(nitmethod_t)core___core__Object___output, /* pointer to ordered_tree:OrderedTreeIterator:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to ordered_tree:OrderedTreeIterator:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to ordered_tree:OrderedTreeIterator:serialization#Object#is_same_serialized */
...
(nitmethod_t)core___core__Object___output, /* pointer to toolcontext:Message:kernel#Object#output */
(nitmethod_t)serialization___core__Object___serialization_hash, /* pointer to toolcontext:Message:serialization#Object#serialization_hash */
(nitmethod_t)serialization___core__Object___is_same_serialized, /* pointer to toolcontext:Message:serialization#Object#is_same_serialized */
