...
#define COLOR_nitc__extern_classes__ToolContext___extern_classes_typing_phase_ast 117
...
#define COLOR_nitc__light_ffi_base__FFILanguage__get_ftype 17
...
#define COLOR_nitc__light_ffi_base__ForeignType__ctype 15
