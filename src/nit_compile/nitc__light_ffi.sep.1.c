...
{
var11 = core__abstract_text___Collection___join(var6, var8, ((val*)NULL));
}
var_cflags = var11;
{
...
{
((void(*)(val* self, val* p0, val* p1, val* p2))(var_language->class->vft[COLOR_nitc__light_ffi_base__FFILanguage__compile_module_block]))(var_language, var_block, var_ffi_ccu, var_mmodule); /* compile_module_block on <var_language:nullable FFILanguage(FFILanguage)>*/
}
{
...
var51 = "._nitni.h\"\n";
var52 = core__abstract_text___CString___to_s_full(var51, 11l, 11l);
var50 = var52;
varonce49 = var50;
}
...
var68 = core__abstract_text___CString___to_s_full(var67, 26l, 26l);
var66 = var68;
varonce65 = var66;
}
{
...
var75 = core__abstract_text___CString___to_s_full(var74, 90l, 90l);
var73 = var75;
varonce72 = var73;
}
{
...
var81 = "#else\n";
var82 = core__abstract_text___CString___to_s_full(var81, 6l, 6l);
var80 = var82;
varonce79 = var80;
}
{
...
var89 = core__abstract_text___CString___to_s_full(var88, 55l, 55l);
var87 = var89;
varonce86 = var87;
}
{
...
var95 = "#endif\n";
var96 = core__abstract_text___CString___to_s_full(var95, 7l, 7l);
var94 = var96;
varonce93 = var94;
}
{
...
((void(*)(val* self, val* p0, val* p1, val* p2, val* p3))(var136->class->vft[COLOR_nitc__light_ffi_base__FFILanguage__compile_extern_class]))(var136, var139, var_nclassdef, var_ffi_ccu, var_mmodule); /* compile_extern_class on <var136:nullable FFILanguage>*/
}
} else {
}
{
...
((void(*)(val* self, val* p0, val* p1, val* p2, val* p3))(var32->class->vft[COLOR_nitc__light_ffi_base__FFILanguage__compile_extern_method]))(var32, var35, self, var38, var_mmodule); /* compile_extern_method on <var32:nullable FFILanguage>*/
}
RET_LABEL:;
}
