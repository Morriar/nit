...
var4 = NEW_core__NativeArray(8l, &type_core__NativeArray__core__String);
...
((struct instance_core__NativeArray*)var4)->values[5]=var14;
...
((struct instance_core__NativeArray*)var4)->values[7]=var18;
} else {
var4 = varonce;
varonce = NULL;
}
{
var21 = ((val*(*)(val* self))(self->class->vft[COLOR_nitc__parser_nodes__ANode__hot_location]))(self); /* hot_location on <self:ANode>*/
}
{
var22 = ((val*(*)(val* self))(var21->class->vft[COLOR_core__abstract_text__Object__to_s]))(var21); /* to_s on <var21:Location>*/
}
((struct instance_core__NativeArray*)var4)->values[0]=var22;
{
var23 = core__abstract_text___Object___class_name(self);
}
((struct instance_core__NativeArray*)var4)->values[2]=var23;
((struct instance_core__NativeArray*)var4)->values[4]=var_message;
{
var24 = ((val*(*)(val* self))(self->class->vft[COLOR_nitc__parser_nodes__ANode__hot_location]))(self); /* hot_location on <self:ANode>*/
}
...
{
var29 = nitc___nitc__Location___colored_line(var24, var26);
}
((struct instance_core__NativeArray*)var4)->values[6]=var29;
{
var30 = ((val*(*)(val* self))(var4->class->vft[COLOR_core__abstract_text__NativeArray__native_to_s]))(var4); /* native_to_s on <var4:NativeArray[String]>*/
}
varonce = var4;
{
((void(*)(val* self, val* p0))(var3->class->vft[COLOR_core__stream__Writer__write]))(var3, var30); /* write on <var3:Writer>*/
}
RET_LABEL:;
}
...
var_n = var3;
{
((void(*)(val* self, val* p0))(var_v->class->vft[COLOR_nitc__parser_nodes__Visitor__enter_visit]))(var_v, var_n); /* enter_visit on <var_v:Visitor>*/
}
{
...
val* nitc___nitc__Token___prev_token(val* self) {
val* var /* : nullable Token */;
val* var1 /* : nullable Token */;
var1 = self->attrs[COLOR_nitc__parser_nodes__Token___prev_token].val; /* _prev_token on <self:Token> */
var = var1;
RET_LABEL:;
return var;
}
...
var4 = "attribute \'";
var5 = core__abstract_text___CString___to_s_full(var4, 11l, 11l);
var3 = var5;
varonce2 = var3;
}
((struct instance_core__NativeArray*)var1)->values[0]=var3;
...
{
var6 = nitc__lexer_work___Token___text(self);
}
...
var5 = core__abstract_text___CString___to_s_full(var4, 20l, 20l);
var3 = var5;
varonce2 = var3;
}
((struct instance_core__NativeArray*)var1)->values[0]=var3;
...
val* nitc___nitc__ALocalPropExternCall___n_methid(val* self) {
val* var /* : AMethid */;
val* var1 /* : AMethid */;
var1 = self->attrs[COLOR_nitc__parser_nodes__ALocalPropExternCall___n_methid].val; /* _n_methid on <self:ALocalPropExternCall> */
if (unlikely(var1 == NULL)) {
...
val* nitc___nitc__AFullPropExternCall___n_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__AFullPropExternCall___n_type].val; /* _n_type on <self:AFullPropExternCall> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _n_type");
...
val* nitc___nitc__AFullPropExternCall___n_methid(val* self) {
val* var /* : AMethid */;
val* var1 /* : AMethid */;
var1 = self->attrs[COLOR_nitc__parser_nodes__AFullPropExternCall___n_methid].val; /* _n_methid on <self:AFullPropExternCall> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _n_methid");
...
val* nitc___nitc__AInitPropExternCall___n_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__AInitPropExternCall___n_type].val; /* _n_type on <self:AInitPropExternCall> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _n_type");
...
val* nitc___nitc__ACastAsExternCall___n_from_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__ACastAsExternCall___n_from_type].val; /* _n_from_type on <self:ACastAsExternCall> */
if (unlikely(var1 == NULL)) {
...
val* nitc___nitc__ACastAsExternCall___n_to_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__ACastAsExternCall___n_to_type].val; /* _n_to_type on <self:ACastAsExternCall> */
if (unlikely(var1 == NULL)) {
...
val* nitc___nitc__AAsNullableExternCall___n_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__AAsNullableExternCall___n_type].val; /* _n_type on <self:AAsNullableExternCall> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _n_type");
...
val* nitc___nitc__AAsNotNullableExternCall___n_type(val* self) {
val* var /* : AType */;
val* var1 /* : AType */;
var1 = self->attrs[COLOR_nitc__parser_nodes__AAsNotNullableExternCall___n_type].val; /* _n_type on <self:AAsNotNullableExternCall> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _n_type");
...
val* nitc___nitc__ASignature___n_opar(val* self) {
val* var /* : nullable TOpar */;
val* var1 /* : nullable TOpar */;
var1 = self->attrs[COLOR_nitc__parser_nodes__ASignature___n_opar].val; /* _n_opar on <self:ASignature> */
var = var1;
RET_LABEL:;
return var;
}
