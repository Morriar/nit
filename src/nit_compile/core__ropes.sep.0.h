...
#define COLOR_core__abstract_text__StringCharView__target_61d 15
#define COLOR_core__kernel__Object__init 0
#define COLOR_core__ropes__Concat___length 1
#define COLOR_core__ropes__Concat___byte_length 2
...
#define COLOR_core__ropes__Concat___left 5
#define COLOR_core__ropes__Concat___right 6
#define COLOR_core__ropes___core__ropes__Concat___core__kernel__Object__init 130
#define COLOR_core__abstract_text__Text__length 29
#define COLOR_core__abstract_text__Text__byte_length 35
#define COLOR_core__ropes__Concat___flat_last_pos_start 4
...
#define COLOR_core__abstract_text__Text__to_upper 106
#define COLOR_core__ropes__Concat__left_61d 125
#define COLOR_core__ropes__Concat__right_61d 126
#define COLOR_core__abstract_text__Text__to_lower 87
...
#define COLOR_core__ropes__RopeCharIteratorPiece__node_61d 20
#define COLOR_core__ropes__RopeCharIteratorPiece__ldone_61d 17
#define COLOR_core__ropes__RopeCharIteratorPiece__rdone_61d 18
#define COLOR_core__ropes__RopeCharIteratorPiece__prev_61d 21
#define COLOR_core__ropes__RopeCharIteratorPiece___node 0
void core___core__AbstractArray___core__abstract_collection__Sequence__push(val* self, val* p0);
#define COLOR_core__ropes__RopeCharIteratorPiece___prev 3
#define COLOR_core__ropes__RopeCharIteratorPiece___ldone 1
#define COLOR_core__ropes__RopeCharIteratorPiece___rdone 2
...
#define COLOR_core__ropes___core__ropes__RopeCharIteratorPiece___core__kernel__Object__init 23
#define COLOR_core__ropes__RopeCharReverseIterator___ns 0
#define COLOR_core__ropes__RopeCharReverseIterator___pns 1
#define COLOR_core__ropes__RopeCharReverseIterator___pos 2
#define COLOR_core__ropes__RopeCharReverseIterator___subs 3
...
#define COLOR_core__ropes__RopeCharIterator___pns 0
#define COLOR_core__ropes__RopeCharIterator___str 1
#define COLOR_core__ropes__RopeCharIterator___subs 2
#define COLOR_core__ropes__RopeCharIterator___max 3
#define COLOR_core__ropes__RopeCharIterator___pos 4
uint32_t core__ropes___core__ropes__RopeCharIterator___core__abstract_collection__Iterator__item(val* self);
#define COLOR_core__ropes__ReverseRopeSubstrings___iter 0
#define COLOR_core__ropes__ReverseRopeSubstrings___pos 1
#define COLOR_core__ropes__ReverseRopeSubstrings___str 2
#define COLOR_core__kernel__Object___61d_61d 3
#define COLOR_core__ropes__RopeSubstrings___iter 0
#define COLOR_core__ropes__RopeSubstrings___pos 1
#define COLOR_core__ropes__RopeSubstrings___max 2
#define COLOR_core__ropes__RopeSubstrings___str 3
