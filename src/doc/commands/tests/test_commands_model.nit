...
class TestCommandsModel
	...
	fun test_cmd_code is test do
		var cmd = new CmdCode(test_model, test_builder, test_filter, mentity_name = "test_prog::Career")
		var res = cmd.init_command
		assert res isa CmdSuccess
	...
	fun test_cmd_code_no_code is test do
		var cmd = new CmdCode(test_model, test_builder, test_filter, mentity_name = "test_prog")
		var res = cmd.init_command
