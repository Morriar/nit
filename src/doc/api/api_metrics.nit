...
class APIStructuralMetrics
	...
	private fun mclasses_metrics: MetricSet do
		...
		metrics.register(new CNOA(config.model, config.mainmodule))
		metrics.register(new CNOP(config.model, config.mainmodule))
		metrics.register(new CNOC(config.model, config.mainmodule))
		metrics.register(new CNOD(config.model, config.mainmodule))
		metrics.register(new CNOAC(config.model, config.mainmodule))
		metrics.register(new CNOAA(config.model, config.mainmodule))
		metrics.register(new CNOAI(config.model, config.mainmodule))
		metrics.register(new CDIT(config.model, config.mainmodule))
		metrics.register(new CNBP(config.model, config.mainmodule))
		metrics.register(new CNBA(config.model, config.mainmodule))
		metrics.register(new CNBM(config.model, config.mainmodule))
		metrics.register(new CNBI(config.model, config.mainmodule))
		metrics.register(new CNBV(config.model, config.mainmodule))
		metrics.register(new CNBIP(config.model, config.mainmodule))
		metrics.register(new CNBRP(config.model, config.mainmodule))
		metrics.register(new CNBHP(config.model, config.mainmodule))
		metrics.register(new CNBLP(config.model, config.mainmodule))
		return metrics
	end

	private fun mmodules_metrics: MetricSet do
		var metrics = new MetricSet
		metrics.register(new MNOA(config.model, config.mainmodule))
		metrics.register(new MNOP(config.model, config.mainmodule))
		metrics.register(new MNOC(config.model, config.mainmodule))
		metrics.register(new MNOD(config.model, config.mainmodule))
		metrics.register(new MDIT(config.model, config.mainmodule))
		metrics.register(new MNBD(config.model, config.mainmodule))
		metrics.register(new MNBI(config.model, config.mainmodule))
		metrics.register(new MNBR(config.model, config.mainmodule))
		metrics.register(new MNBCC(config.model, config.mainmodule))
		metrics.register(new MNBAC(config.model, config.mainmodule))
		return metrics
	end
