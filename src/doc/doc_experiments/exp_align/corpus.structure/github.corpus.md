...
> struct: github::GithubAPI

### `load_user` - # Get the Github user with `login`

> struct: github::GithubAPI::load_user
...
> struct: github::GithubAPI::load_repo
...
> struct: github::caching

#### Custom requests

> struct: github::GithubAPI::get
...
> struct: github::GithubAPI::user_agent
...
> struct: github::GithubAPI::verbose_level
...
> struct: github::GithubAPI::api_url
