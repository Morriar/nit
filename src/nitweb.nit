...
redef class ToolContext
	...
	init do
		super
		option_context.add_option(opt_config, opt_host, opt_port, opt_no_private, opt_no_fictive, opt_no_test, opt_no_attribute, opt_no_empty_doc)
	end
end
...
private class NitwebPhase
	...
	fun build_config(toolcontext: ToolContext, mainmodule: MModule): NitwebConfig do
		...
		var view = new ModelView(model,
			...
			include_fictive = not toolcontext.opt_no_fictive.value,
			include_empty_doc = not toolcontext.opt_no_empty_doc.value,
			include_test = not toolcontext.opt_no_test.value,
			include_attribute = not toolcontext.opt_no_attribute.value)
