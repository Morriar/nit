...
# more than two children by node.
module tree
...
# Each node can have none, one or many children.
#
# Usage:
#
# ~~~
...
# ~~~
#
# Use `show_dot` to display a graphic representation of a tree using Graphviz.
#
...
class Tree[K: Comparable, E]
	...
	# Set `node.parent = parent` otherwise.
	#
	...
	# ~~~
	var nodes: Map[K, N] = new HashMap[K, N]
	...
	#
	# Two trees are considered similar if their edit distance is equal to 0.
