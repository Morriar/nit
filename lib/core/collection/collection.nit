...
redef class SequenceRead[E]
	...
	# assert [4].levenshtein_distance([1, 2, 3, 4])     == 3
	# assert [1, 2, 3, 4].levenshtein_distance([4])     == 3
	# assert [1, 2, 3, 4].levenshtein_distance([5, 6, 7])  == 4
	# assert [1, 2, 3, 4].levenshtein_distance([5, 2, 3, 6]) == 2
	# ~~~
	fun levenshtein_distance(other: SequenceRead[E]): Int do
