...
There is a single API to write [[json | text: JSON]], and three API to read depending on the use case.

## Write JSON

[[uml: json | format: svg, mentities: json::json;json::error;json::store;json::dynamic;json::serialization_read;json::serialization_write;json::static]]
...
* the module [[json::dynamic | text: `json::dynamic`]] provides an easy API to explore [[json::json | text: JSON]] objects,
* the module [[json::static | text: `json::static`]] offers a low-level service to parse JSON and create basic Nit objects.

The class [[json::JsonDeserializer | text: `JsonDeserializer`]] reads JSON code to recreate objects.
...
1. The JSON object defines a `__class` key with the name of the Nit class as value.
   This attribute is generated by the [[json::JsonSerializer | text: `JsonSerializer`]] with other metadata,
