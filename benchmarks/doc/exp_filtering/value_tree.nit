...
class ValueTree
	...
	# Remnove a node and all it's subnodes
	fun remove_node(node: ValueNode) do
		...
		ids.keys.remove(node.key)
	end

	# Tree nodes mapped to their post order keys
	# ~~~
	...
	#    h
	#    i""".split("\n"))
	# assert tree.ids[1].to_s == "\{d\}"
	# assert tree.ids[9].to_s == "\{a\}"
	# ~~~
	...
	# ~~~
	fun preorder: Array[ValueNode] do
		var root = self.root
		var nodes = new Array[ValueNode]
		if root == null then return nodes
		var todos = new Array[ValueNode]
		todos.add root
	...
	# ~~~
	fun postorder: Array[ValueNode] do
		var root = self.root
		var nodes = new Array[ValueNode]
		if root == null then return nodes
...
class ValueNode
	...
	#    h
	#    i""".split("\n"))
	# assert tree.ids[9].depth == 0
	# assert tree.ids[6].depth == 3
	# assert tree.ids[1].depth == 2
	# ~~~
	redef fun depth do
	...
	#    h
	#    i""".split("\n"))
	# assert tree.ids[9].lmd == tree.ids[1]
	# assert tree.ids[6].lmd == tree.ids[6]
	# assert tree.ids[1].lmd == tree.ids[1]
	# ~~~
	fun lmd: N do
	...
	#    h
	#    i""".split("\n"))
	# assert tree.ids[1].keyroot == tree.ids[9]
	# assert tree.ids[2].keyroot == tree.ids[9]
	# assert tree.ids[3].keyroot == tree.ids[8]
	# assert tree.ids[4].keyroot == tree.ids[8]
	# assert tree.ids[5].keyroot == tree.ids[7]
	# assert tree.ids[6].keyroot == tree.ids[6]
	# assert tree.ids[7].keyroot == tree.ids[7]
	# assert tree.ids[8].keyroot == tree.ids[8]
	# assert tree.ids[9].keyroot == tree.ids[9]
	# ~~~
	fun keyroot: N do
