...
short int var12 /* : Bool */;
long var_i /* var i: Int */;
val* var13 /* : nullable NativeArray[nullable Object] */;
...
var_i = 0l;
var13 = self->attrs[COLOR_core__array__Array___items].val; /* _items on <self:Array[nullable Object]> */
...
var_it = var13;
var14 = var_o->attrs[COLOR_core__array__Array___items].val; /* _items on <var_o:nullable Object(Array[nullable Object])> */
if (unlikely(var14 == NULL)) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
var23 = ((struct instance_core__NativeArray*)var_it)->values[var_i];
var21 = var23;
goto RET_LABEL22;
RET_LABEL22:(void)0;
}
...
var26 = ((struct instance_core__NativeArray*)var_oit)->values[var_i];
var24 = var26;
goto RET_LABEL25;
RET_LABEL25:(void)0;
}
...
var28 = ((short int(*)(val* self, val* p0))((((long)var21&3)?class_info[((long)var21&3)]:var21->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var21, var24); /* != on <var21:nullable Object>*/
var27 = var28;
}
if (var27){
var = 0;
...
short int var3 /* : Bool */;
short int var5 /* : Bool */;
val* var6 /* : nullable NativeArray[nullable Object] */;
val* var_it /* var it: NativeArray[nullable Comparable] */;
val* var7 /* : nullable NativeArray[nullable Object] */;
val* var_oit /* var oit: NativeArray[nullable Comparable] */;
long var8 /* : Int */;
...
var_class_name = p0 == NULL ? "null" : p0->type->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 923);
fatal_exit(1);
}
var_o = p0;
var_i = 0l;
{
var2 = ((long(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:ArrayCmp[nullable Comparable]>*/
}
var_l = var2;
{
{ /* Inline kernel$Int$== (var_l,0l) on <var_l:Int> */
...
var6 = self->attrs[COLOR_core__array__Array___items].val; /* _items on <self:ArrayCmp[nullable Comparable]> */
if (unlikely(var6 == NULL)) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 928);
fatal_exit(1);
}
var_it = var6;
var7 = var_o->attrs[COLOR_core__array__Array___items].val; /* _items on <var_o:ArrayCmp[nullable Comparable]> */
if (unlikely(var7 == NULL)) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "Cast failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__array, 929);
fatal_exit(1);
}
var_oit = var7;
{
var8 = ((long(*)(val* self))(var_o->class->vft[COLOR_core__abstract_collection__Collection__length]))(var_o); /* length on <var_o:ArrayCmp[nullable Comparable]>*/
}
var_ol = var8;
{
...
var11 = 1; /* easy <var_ol:Int> isa OTHER*/
if (unlikely(!var11)) {
var_class_name14 = type_core__Int.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name14);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 725);
...
var20 = 1; /* easy <var_len:nullable Object(Int)> isa OTHER*/
if (unlikely(!var20)) {
var_class_name23 = var_len == NULL ? "null" : (((long)var_len&3)?type_info[((long)var_len&3)]:var_len->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name23);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 725);
fatal_exit(1);
}
var24 = (long)(var_len)>>2;
var25 = var_i < var24;
var18 = var25;
goto RET_LABEL19;
RET_LABEL19:(void)0;
...
if (var18){
{
{ /* Inline array$NativeArray$[] (var_it,var_i) on <var_it:NativeArray[nullable Comparable]> */
var28 = ((struct instance_core__NativeArray*)var_it)->values[var_i];
var26 = var28;
goto RET_LABEL27;
RET_LABEL27:(void)0;
}
...
var_a = var26;
{
{ /* Inline array$NativeArray$[] (var_oit,var_i) on <var_oit:NativeArray[nullable Comparable]> */
var31 = ((struct instance_core__NativeArray*)var_oit)->values[var_i];
var29 = var31;
goto RET_LABEL30;
RET_LABEL30:(void)0;
}
...
if (0) {
var33 = ((short int(*)(val* self, val* p0))((((long)var_a&3)?class_info[((long)var_a&3)]:var_a->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_a, ((val*)NULL)); /* != on <var_a:nullable Comparable>*/
var32 = var33;
}
if (var32){
if (var_b == NULL) {
...
if (0) {
var35 = ((short int(*)(val* self, val* p0))((((long)var_b&3)?class_info[((long)var_b&3)]:var_b->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var_b, ((val*)NULL)); /* == on <var_b:nullable Comparable>*/
var34 = var35;
}
if (var34){
var = 1l;
...
{
var36 = ((long(*)(val* self, val* p0))((((long)var_a&3)?class_info[((long)var_a&3)]:var_a->class)->vft[COLOR_core__kernel__Comparable___60d_61d_62d]))(var_a, var_b); /* <=> on <var_a:nullable Comparable(Comparable)>*/
}
var_d = var36;
{
...
if (0) {
var42 = ((short int(*)(val* self, val* p0))((((long)var_b&3)?class_info[((long)var_b&3)]:var_b->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_b, ((val*)NULL)); /* != on <var_b:nullable Comparable>*/
var41 = var42;
}
if (var41){
{
...
BREAK_label: (void)0;
var53 = core___core__Int___Comparable___60d_61d_62d(var_l, var_ol);
var = var53;
goto RET_LABEL;
RET_LABEL:;
return var;
