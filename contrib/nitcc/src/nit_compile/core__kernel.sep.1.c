...
/* method kernel$Byte$is_whitespace for (self: Byte): Bool */
short int core___core__Byte___is_whitespace(unsigned char self) {
short int var /* : Bool */;
short int var1 /* : Bool */;
short int var2 /* : Bool */;
short int var4 /* : Bool */;
...
short int var8 /* : Bool */;
{
{ /* Inline kernel$Byte$== (self,((unsigned char)0x7f)) on <self:Byte> */
var4 = self == ((unsigned char)0x7f);
var2 = var4;
goto RET_LABEL3;
RET_LABEL3:(void)0;
}
...
{
{ /* Inline kernel$Byte$<= (self,((unsigned char)0x20)) on <self:Byte> */
/* Covariant cast for argument 0 (i) <((unsigned char)0x20):Byte> isa OTHER */
/* <((unsigned char)0x20):Byte> isa OTHER */
var7 = 1; /* easy <((unsigned char)0x20):Byte> isa OTHER*/
if (unlikely(!var7)) {
var_class_name = type_core__Byte.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 618);
...
if (var2){
{
var3 = ((short int(*)(val* self, val* p0))(self->class->vft[COLOR_core__kernel__Pointer__native_equals]))(self, var_o); /* native_equals on <self:Pointer>*/
}
var1 = var3;
} else {
var1 = var_;
