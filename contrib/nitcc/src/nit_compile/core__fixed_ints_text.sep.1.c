...
var1 = core__fixed_ints_text___Int8___to_s_len(self);
var_nslen = var1;
...
core__fixed_ints_text___Int8___native_to_s(self, var_ns, var12); /* Direct call fixed_ints_text$Int8$native_to_s on <self:Int8>*/
var20 = (val*)(var_nslen<<2|1);
var21 = (val*)((long)(0)<<2|3);
var19 = core__flat___CString___to_s_unsafe(var_ns, var20, ((val*)NULL), var21, ((val*)NULL));
var = var19;
goto RET_LABEL;
RET_LABEL:;
return var;
...
val* var20 /* : nullable Int */;
val* var21 /* : nullable Bool */;
var1 = core__fixed_ints_text___Int16___to_s_len(self);
var_nslen = var1;
if (likely(varoncenew_guard)) {
var2 = varoncenew;
} else {
...
core__fixed_ints_text___Int16___native_to_s(self, var_ns, var12); /* Direct call fixed_ints_text$Int16$native_to_s on <self:Int16>*/
var20 = (val*)(var_nslen<<2|1);
var21 = (val*)((long)(0)<<2|3);
var19 = core__flat___CString___to_s_unsafe(var_ns, var20, ((val*)NULL), var21, ((val*)NULL));
var = var19;
...
val* var20 /* : nullable Int */;
val* var21 /* : nullable Bool */;
var1 = core__fixed_ints_text___UInt16___to_s_len(self);
var_nslen = var1;
if (likely(varoncenew_guard)) {
var2 = varoncenew;
} else {
...
core__fixed_ints_text___UInt16___native_to_s(self, var_ns, var12); /* Direct call fixed_ints_text$UInt16$native_to_s on <self:UInt16>*/
var20 = (val*)(var_nslen<<2|1);
var21 = (val*)((long)(0)<<2|3);
var19 = core__flat___CString___to_s_unsafe(var_ns, var20, ((val*)NULL), var21, ((val*)NULL));
var = var19;
...
val* var20 /* : nullable Int */;
val* var21 /* : nullable Bool */;
var1 = core__fixed_ints_text___Int32___to_s_len(self);
var_nslen = var1;
if (likely(varoncenew_guard)) {
var2 = varoncenew;
} else {
...
core__fixed_ints_text___Int32___native_to_s(self, var_ns, var12); /* Direct call fixed_ints_text$Int32$native_to_s on <self:Int32>*/
var20 = (val*)(var_nslen<<2|1);
var21 = (val*)((long)(0)<<2|3);
var19 = core__flat___CString___to_s_unsafe(var_ns, var20, ((val*)NULL), var21, ((val*)NULL));
var = var19;
...
val* var20 /* : nullable Int */;
val* var21 /* : nullable Bool */;
var1 = core__fixed_ints_text___UInt32___to_s_len(self);
var_nslen = var1;
if (likely(varoncenew_guard)) {
var2 = varoncenew;
} else {
...
core__fixed_ints_text___UInt32___native_to_s(self, var_ns, var12); /* Direct call fixed_ints_text$UInt32$native_to_s on <self:UInt32>*/
var20 = (val*)(var_nslen<<2|1);
var21 = (val*)((long)(0)<<2|3);
var19 = core__flat___CString___to_s_unsafe(var_ns, var20, ((val*)NULL), var21, ((val*)NULL));
var = var19;
...
val* var10 /* : Text */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__get_numhead]))(self); /* get_numhead on <self:Text>*/
}
...
{
var9 = ((short int(*)(val* self, val* p0))(var1->class->vft[COLOR_core__kernel__Object___33d_61d]))(var1, var2); /* != on <var1:Text>*/
}
if (var9){
{
var10 = ((val*(*)(val* self, long p0))(self->class->vft[COLOR_core__abstract_text__Text__substring_from]))(self, 2l); /* substring_from on <self:Text>*/
}
var = var10;
goto RET_LABEL;
} else {
...
val* var16 /* : Text */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__get_numext]))(self); /* get_numext on <self:Text>*/
}
var_ext = var1;
if (likely(varonce!=NULL)) {
var2 = varonce;
...
{
var9 = ((short int(*)(val* self, val* p0))(var_ext->class->vft[COLOR_core__kernel__Object___33d_61d]))(var_ext, var2); /* != on <var_ext:Text>*/
}
if (var9){
{
...
{
var11 = ((long(*)(val* self))(var_ext->class->vft[COLOR_core__abstract_text__Text__length]))(var_ext); /* length on <var_ext:Text>*/
}
{
...
{
var16 = ((val*(*)(val* self, long p0, long p1))(self->class->vft[COLOR_core__abstract_text__Text__substring]))(self, 0l, var12); /* substring on <self:Text>*/
}
var = var16;
goto RET_LABEL;
} else {
...
var_s = var24;
{
var25 = ((val*(*)(val* self))(var_s->class->vft[COLOR_core__fixed_ints_text__Text__strip_numhead]))(var_s); /* strip_numhead on <var_s:String>*/
}
var_rets = var25;
if (likely(varonce!=NULL)) {
var26 = varonce;
...
{
var34 = ((val*(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__get_numhead]))(self); /* get_numhead on <self:Text>*/
}
var_hd = var34;
...
if (var35){
{
var55 = ((short int(*)(val* self))(var_rets->class->vft[COLOR_core__abstract_text__Text__is_hex]))(var_rets); /* is_hex on <var_rets:Text>*/
}
var = var55;
goto RET_LABEL;
} else {
...
if (var56){
{
var76 = ((short int(*)(val* self))(var_rets->class->vft[COLOR_core__abstract_text__Text__is_bin]))(var_rets); /* is_bin on <var_rets:Text>*/
}
var = var76;
goto RET_LABEL;
} else {
...
if (var77){
{
var97 = ((short int(*)(val* self))(var_rets->class->vft[COLOR_core__abstract_text__Text__is_oct]))(var_rets); /* is_oct on <var_rets:Text>*/
}
var = var97;
goto RET_LABEL;
} else {
...
{
var98 = ((short int(*)(val* self))(var_rets->class->vft[COLOR_core__abstract_text__Text__is_dec]))(var_rets); /* is_dec on <var_rets:Text>*/
}
var = var98;
goto RET_LABEL;
RET_LABEL:;
...
long var58 /* : Int */;
{
var1 = ((short int(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__is_int]))(self); /* is_int on <self:Text>*/
}
if (unlikely(!var1)) {
...
var_prefix = var1;
{
var2 = ((val*(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__strip_numhead]))(self); /* strip_numhead on <self:Text>*/
}
{
var3 = ((val*(*)(val* self))(var2->class->vft[COLOR_core__fixed_ints_text__Text__strip_numext]))(var2); /* strip_numext on <var2:Text>*/
}
{
var4 = (val*)((long)('_')<<2|2);
...
{
var13 = ((short int(*)(val* self, val* p0))(var_prefix->class->vft[COLOR_core__kernel__Object___33d_61d]))(var_prefix, var6); /* != on <var_prefix:Text>*/
}
if (var13){
{
var14 = ((uint32_t(*)(val* self, long p0))(var_prefix->class->vft[COLOR_core__abstract_text__Text___91d_93d]))(var_prefix, 1l); /* [] on <var_prefix:Text>*/
}
var_c = var14;
{
{ /* Inline kernel$Char$== (var_c,'x') on <var_c:Char> */
...
if (var15){
{
var22 = ((short int(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__is_hex]))(var_s); /* is_hex on <var_s:String>*/
}
var = var22;
goto RET_LABEL;
} else {
...
if (var23){
{
var31 = ((short int(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__is_oct]))(var_s); /* is_oct on <var_s:String>*/
}
var = var31;
goto RET_LABEL;
} else {
...
if (var32){
{
var40 = ((short int(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__is_bin]))(var_s); /* is_bin on <var_s:String>*/
}
var = var40;
goto RET_LABEL;
} else {
...
{
var41 = ((short int(*)(val* self))(var_s->class->vft[COLOR_core__abstract_text__Text__is_dec]))(var_s); /* is_dec on <var_s:String>*/
}
var = var41;
goto RET_LABEL;
RET_LABEL:;
...
{
var1 = ((short int(*)(val* self))(self->class->vft[COLOR_core__fixed_ints_text__Text__is_num]))(self); /* is_num on <self:Text>*/
}
var2 = !var1;
if (var2){
var = ((val*)NULL);
...
var_s = var4;
{
var5 = ((val*(*)(val* self))(var_s->class->vft[COLOR_core__fixed_ints_text__Text__get_numext]))(var_s); /* get_numext on <var_s:String>*/
}
var_ext = var5;
{
var6 = ((val*(*)(val* self))(var_s->class->vft[COLOR_core__fixed_ints_text__Text__strip_numext]))(var_s); /* strip_numext on <var_s:String>*/
}
var_trunk = var6;
{
var7 = ((val*(*)(val* self))(var_trunk->class->vft[COLOR_core__fixed_ints_text__Text__strip_numhead]))(var_trunk); /* strip_numhead on <var_trunk:Text>*/
}
if (likely(varonce!=NULL)) {
var8 = varonce;
} else {
...
{
var16 = ((long(*)(val* self))(var_trunk->class->vft[COLOR_core__abstract_text__Text__to_i]))(var_trunk); /* to_i on <var_trunk:Text>*/
}
var_trval = var16;
