...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Set[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 475);
fatal_exit(1);
}
var_other = p0;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 494);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 519);
fatal_exit(1);
}
var_key = p0;
var_default = p1;
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "iterator", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 542);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 545);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 555);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 565);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 583);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]=", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 671);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "MapRead[K, V]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 710);
fatal_exit(1);
}
var_map = p0;
{
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "clear", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 713);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "keys", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 725);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "item", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 730);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 734);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "next", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 738);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "is_ok", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 742);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 812);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "iterator", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 965);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1017);
fatal_exit(1);
}
var_item = p0;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1042);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]=", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1097);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = p1 == NULL ? "null" : (((long)p1&3)?type_info[((long)p1&3)]:p1->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1112);
fatal_exit(1);
}
var_index = p0;
var_value = p1;
...
/* method abstract_collection$Sequence$rotate_left for (self: Sequence[nullable Object]) */
void core___core__Sequence___rotate_left(val* self) {
val* var /* : nullable Object */;
val* var_fst /* var fst: nullable Object */;
{
var = ((val*(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__shift]))(self); /* shift on <self:Sequence[nullable Object]>*/
}
var_fst = var;
{
((void(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__push]))(self, var_fst); /* push on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection$Sequence$rotate_right for (self: Sequence[nullable Object]) */
void core___core__Sequence___rotate_right(val* self) {
val* var /* : nullable Object */;
val* var_lst /* var lst: nullable Object */;
{
var = ((val*(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__pop]))(self); /* pop on <self:Sequence[nullable Object]>*/
}
var_lst = var;
{
((void(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence__unshift]))(self, var_lst); /* unshift on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1197);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1206);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1210);
fatal_exit(1);
RET_LABEL:;
return var;
}
