...
/* method re$CString$substring_from for (self: CString, Int): CString */
char* core__re___CString___substring_from(char* self, long p0) {
char* var /* : CString */;
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
/* method re$Regex$extended= for (self: Regex, Bool) */
void core___core__Regex___extended_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$ignore_case= for (self: Regex, Bool) */
void core___core__Regex___ignore_case_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$optimize_has= for (self: Regex, Bool) */
void core___core__Regex___optimize_has_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$newline= for (self: Regex, Bool) */
void core___core__Regex___newline_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$not_bol= for (self: Regex, Bool) */
void core___core__Regex___not_bol_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$not_eol= for (self: Regex, Bool) */
void core___core__Regex___not_eol_61d(val* self, short int p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Regex$native_match= for (self: Regex, NativeMatchArray) */
void core___core__Regex___native_match_61d(val* self, val* p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
val* core___core__Regex___core__string_search__Pattern__search_all_in(val* self, val* p0) {
val* var /* : Array[Match] */;
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
/* method re$Match$subs= for (self: Match, Array[nullable Match]) */
void core__re___Match___subs_61d(val* self, val* p0) {
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
PRINT_ERROR("Runtime error: %s", "FATAL: Dead method executed.");
...
/* method re$Match$[] for (self: Match, Int): nullable Match */
val* core__re___Match____91d_93d(val* self, long p0) {
val* var /* : nullable Match */;
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
long core__re___Sys___error_nomatch(val* self) {
long var /* : Int */;
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
...
long core__re___Sys___error_espace(val* self) {
long var /* : Int */;
if(catchStack.cursor >= 0){
longjmp(catchStack.envs[catchStack.cursor], 1);
}
